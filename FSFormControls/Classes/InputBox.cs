...
{
    #region DBInputBox return result
    ...
    public class InputBox
    {
        ...
        private static void LoadForm()
        {
            ...
            if (_xPos >= 0 && _xPos < workingRectangle.Width - 100 && _yPos >= 0 &&
                _yPos < workingRectangle.Height - 100)
            {
        ...
        {
            DoIt(DialogResult.OK, txtInput.Text);
        }

        private static void btnCancel_Click(object sender, EventArgs e)
        {
            DoIt(DialogResult.Cancel, string.Empty);
        }

        private static void DoIt(DialogResult dr, string text)
        {
            OutputResponse.ReturnCode = dr;
            OutputResponse.Text = text;
        ...
        private static InputBoxResult OutputResponse { get; } = new InputBoxResult();
