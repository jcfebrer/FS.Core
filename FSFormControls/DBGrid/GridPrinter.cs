...
namespace FSFormControls
{
    public class GridPrinter
    {
        ...
        private readonly DataGrid m_DataGrid;
        ...
        public GridPrinter(DataGrid aGrid, System.Drawing.Printing.PrintDocument aPrintDocument, DataTable aTable,
            DBColumnCollection aColumns)
        {
            m_DataGrid = aGrid;
        ...
        {
            var ForeBrush = new SolidBrush(m_DataGrid.HeaderForeColor);
            var BackBrush = new SolidBrush(m_DataGrid.HeaderBackColor);
            var TheLinePen = new Pen(m_DataGrid.GridLineColor, 1);
            ...
            for (k = 0; k <= m_Columns.Count - 1; k++)
                if (m_Columns[k].Hidden == false)
                {
                    ...
                    var cellbounds = new RectangleF(startxposition,
                        ...
                        columnwidth,
                        m_DataGrid.HeaderFont.SizeInPoints + kVerticalCellLeeway);
                    ...
                    if (startxposition + columnwidth <= PageWidth + LeftMargin + RightMargin)
                        g.DrawString(nextcolumn, m_DataGrid.HeaderFont, ForeBrush, cellbounds, cellformat);
                    startxposition = startxposition + columnwidth;
                }

            if (m_DataGrid.GridLineStyle != DataGridLineStyle.None)
        ...
        public bool DrawRows(Graphics g)
        {
            ...
            try
            {
                ...
                var AlternatingBackBrush = new SolidBrush(m_DataGrid.AlternatingBackColor);
                var TheLinePen = new Pen(m_DataGrid.GridLineColor, 1);
                var cellformat = new StringFormat();
                cellformat.Trimming = StringTrimming.EllipsisCharacter;
                cellformat.FormatFlags = StringFormatFlags.NoWrap | StringFormatFlags.LineLimit;
        ...
        private void DrawHorizontalLines(Graphics g, ArrayList lines)
        {
            ...
            if (m_DataGrid.GridLineStyle == DataGridLineStyle.None) return;
        ...
        {
            g.DrawString(m_DataGrid.CaptionText, m_DataGrid.CaptionFont, new SolidBrush(m_DataGrid.ForeColor),
