//-----------------------------------------------------------------------
// <copyright file="FirebaseDB.cs" company="AshishVishwakarma.com">
// Github/AshV
// </copyright>
// <author>Ashish Vishwakarma</author>
//-----------------------------------------------------------------------
namespace FSGoogleFirebaseCore.Database
{
    ...
    public class FirebaseDB
    {
        ...
        /// <summary>
        /// Make Get request with path
        /// </summary>
        /// <returns>Firebase Response</returns>
        public FirebaseResponse Get(string nodePath)
        {
            return new FirebaseRequest(HttpMethod.Get, this.RootNode + '/' + nodePath).Execute();
        }
