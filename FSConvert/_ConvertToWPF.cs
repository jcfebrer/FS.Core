...
namespace FSConvert
{
    public class _ConvertToWPF
    {
        ...
        (
            "DBButtonEx",
            @"(?:this\.)?(?<name>[a-zA-Z0-9_]+)\s*=\s*new\s*FSFormControls\.DBButtonEx\(\);\s*
              (?=.*(?:this\.)?\k<name>\.Location\s*=\s*new\s*System\.Drawing\.Point\((?<x>\d+),\s*(?<y>\d+)\))?
              (?=.*(?:this\.)?\k<name>\.Size\s*=\s*new\s*System\.Drawing\.Size\((?<width>\d+),\s*(?<height>\d+)\))?
              (?=.*(?:this\.)?\k<name>\.Text\s*=\s*""(?<text>[^""]+)"" )?
              (?=.*(?:this\.)?\k<name>\.Anchor\s*=\s*\(\(System\.Windows\.Forms\.AnchorStyles\)\((?<anchor>[^\)]+)\)\); )?
        ...
        (
            "DBLabelEx",
            @"(?:this\.)?(?<name>[a-zA-Z0-9_]+)\s*=\s*new\s*FSFormControls\.DBLabelEx\(\);\s*
              (?=.*(?:this\.)?\k<name>\.Location\s*=\s*new\s*System\.Drawing\.Point\((?<x>\d+),\s*(?<y>\d+)\))?
              (?=.*(?:this\.)?\k<name>\.Size\s*=\s*new\s*System\.Drawing\.Size\((?<width>\d+),\s*(?<height>\d+)\))?
              (?=.*(?:this\.)?\k<name>\.Text\s*=\s*""(?<text>[^""]+)"" )?
              (?=.*(?:this\.)?\k<name>\.Anchor\s*=\s*\(\(System\.Windows\.Forms\.AnchorStyles\)\((?<anchor>[^\)]+)\)\); )?
        ...
        (
            "DBTextBoxEx",
            @"(?:this\.)?(?<name>[a-zA-Z0-9_]+)\s*=\s*new\s*FSFormControls\.DBTextBoxEx\(\);\s*
              (?=.*(?:this\.)?\k<name>\.Location\s*=\s*new\s*System\.Drawing\.Point\((?<x>\d+),\s*(?<y>\d+)\))?
              (?=.*(?:this\.)?\k<name>\.Size\s*=\s*new\s*System\.Drawing\.Size\((?<width>\d+),\s*(?<height>\d+)\))?
              (?=.*(?:this\.)?\k<name>\.Text\s*=\s*""(?<text>[^""]+)"" )?
              (?=.*(?:this\.)?\k<name>\.Anchor\s*=\s*\(\(System\.Windows\.Forms\.AnchorStyles\)\((?<anchor>[^\)]+)\)\); )?
        ...
        (
            "DBGridViewEx",
            @"
            (?:this\.)?(?<name>[a-zA-Z0-9_]+)\s*=\s*new\s*FSFormControls\.DBGridViewEx\(\);
            (?=.*(?:this\.)?\k<name>\.Location\s*=\s*new\s*System\.Drawing\.Point\((?<x>\d+),\s*(?<y>\d+)\))?
            (?=.*(?:this\.)?\k<name>\.Size\s*=\s*new\s*System\.Drawing\.Size\((?<width>\d+),\s*(?<height>\d+)\))?
            (?=.*(?:this\.)?\k<name>\.Anchor\s*=\s*\(\(System\.Windows\.Forms\.AnchorStyles\)\((?<anchor>[^\)]+)\)\); )?
            (?=.*(?:this\.)?\k<name>\.Dock\s*=\s*System\.Windows\.Forms\.DockStyle\.(?<dock>\w+); )?
        ...
        (
            ...
            var containerRegex = new Regex(
                @"(?:this\.)?(?<container>\w+)\.Controls\.Add\((?:this\.)?\s*(?<child>\w+)\s*\);",
