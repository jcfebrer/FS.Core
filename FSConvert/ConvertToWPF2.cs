...
namespace FSConvert
{
    public class ConvertToWPF2
    {
        ...
        private static readonly Dictionary<string, string> EventMapping = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "CheckedChanged", "Checked" }, // Nota: En WPF se suele manejar Checked/Unchecked, mapeamos a Checked por compatibilidad directa
            { "Load", "Loaded" },
            { "Leave", "LostFocus" },
            { "Enter", "GotFocus" },
            { "KeyDown", "KeyDown" },
        ...
        public static string Convert(string designerCode)
        {
            ...
            string windowTitle = "Mantenimiento de servicios";
                ...
                while ((line = reader.ReadLine()) != null)
                {
                    ...
                    if (line.Contains("+="))
                    {
                        ...
                        if (leftSide.Contains("."))
                        {
                            ...
                            // Extraer el nombre del método apuntado (ej: new EventHandler(this.Metodo_Click) -> Metodo_Click)
                            ...
                            {
                                // Traducir el nombre del evento a su equivalente de WPF si existe
            ...
            XElement xamlRoot = new XElement(xmlw + "Window",
                ...
                new XAttribute(xmlx + "Class", "Gt.Views.MantenimientoServiciosView"),
            ...
            XNamespace nsFs)
        {
            ...
            // INYECCIÓN DE PROPIEDADES EXTRAÍDAS
            ...
            // INYECCIÓN DE EVENTOS EXTRAÍDOS DESDE EL .DESIGNER.CS ORIGINAL
            ...
            // GESTIÓN RECURSIVA DE RELACIONES CONTENEDORAS
