...
var lwRTE = function(a, b) {
    ...
    if (document.designMode || document.contentEditable) {
        ...
        $(".rte-resizer a", $(a).parents(".rte-zone")).mousedown(function(d) {
            $(document).mousemove(function(f) { return lwRTE_resizer.mousemove(c, f); });
            $(document).mouseup(function(f) { return lwRTE_resizer.mouseup(c, f); });
...
lwRTE.prototype.enable_design_mode = function() {
    ...
    try {
        ...
        $(a.iframe_doc).focus(function() { a.iframe_doc.designMode(); });
    }
    a.iframe_doc.open();
    ...
    $(a.iframe).parents("form").submit(function() { a.disable_design_mode(true); });
    ...
    $(a.iframe_doc).keyup(function(e) { a.set_selected_controls(a.get_selected_element(), a.controls.rte); });
    if (!$.browser.msie) {
...
lwRTE.prototype.set_content = function(a) { (this.iframe) ? $("body", this.iframe_doc).html(a) : $(this.textarea).val(a); };
