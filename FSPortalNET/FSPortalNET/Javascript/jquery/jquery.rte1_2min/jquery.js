 ...
 */
(function() {
    var l = this, g, x = l.jQuery, o = l.$, n = l.jQuery = l.$ = function(D, E) { return new n.fn.init(D, E); }, C = /^[^<]*(<(.|\s)+>)[^>]*$|^#([\w-]+)$/, f = /^.[^:#\[\.,]*$/;
    n.fn = n.prototype = {
        init: function(D, G) {
            D = D || document;
            if (D.nodeType) {
        ...
        get: function(D) { return D === g ? n.makeArray(this) : this[D]; },
        ...
        each: function(E, D) { return n.each(this, E, D); },
        index: function(D) { return n.inArray(D && D.jquery ? D[0] : D, this); },
        attr: function(E, G, F) {
            var D = E;
            if (typeof E === "string") {
                if (G === g) {
        ...
        wrapInner: function(D) { return this.each(function() { n(this).contents().wrapAll(D); }); },
        wrap: function(D) { return this.each(function() { n(this).wrapAll(D); }); },
        append: function() {
        ...
        before: function() { return this.domManip(arguments, false, function(D) { this.parentNode.insertBefore(D, this); }); },
        after: function() { return this.domManip(arguments, false, function(D) { this.parentNode.insertBefore(D, this.nextSibling); }); },
        ...
        find: function(D) {
            if (this.length === 1 && !/,/.test(D)) {
                ...
                var E = n.map(this, function(G) { return n.find(D, G); });
        ...
        filter: function(D) { return this.pushStack(n.isFunction(D) && n.grep(this, function(F, E) { return D.call(F, E); }) || n.multiFilter(D, n.grep(this, function(E) { return E.nodeType === 1; })), "filter", D); },
        closest: function(D) {
        ...
        not: function(D) {
            ...
            return this.filter(function() { return E ? n.inArray(this, D) < 0 : this != D; });
        },
        add: function(D) { return this.pushStack(n.unique(n.merge(this.get(), typeof D === "string" ? n(D) : n.makeArray(D)))); },
        is: function(D) { return !!D && n.multiFilter(D, this).length > 0; },
        hasClass: function(D) { return !!D && this.is("." + D); },
        val: function(J) {
            if (J === g) {
                var D = this[0];
                if (D) {
            ...
            return this.each(function() {
                ...
                if (n.isArray(J) && /radio|checkbox/.test(this.type)) {
                    ...
                    if (n.nodeName(this, "select")) {
                        var M = n.makeArray(J);
                        n("option", this).each(function() { this.selected = (n.inArray(this.value, M) >= 0 || n.inArray(this.text, M) >= 0); });
                        if (!M.length) {
        ...
        html: function(D) { return D === g ? (this[0] ? this[0].innerHTML : null) : this.empty().append(D); },
        replaceWith: function(D) { return this.after(D).remove(); },
        eq: function(D) { return this.slice(D, +D + 1); },
        slice: function() { return this.pushStack(Array.prototype.slice.apply(this, arguments), "slice", Array.prototype.slice.call(arguments).join(",")); },
        map: function(D) { return this.pushStack(n.map(this, function(F, E) { return D.call(F, E, F); })); },
        ...
        domManip: function(J, M, L) {
            ...
            function K(N, O) { return M && n.nodeName(N, "table") && n.nodeName(O, "tr") ? (N.getElementsByTagName("tbody")[0] || N.appendChild(N.ownerDocument.createElement("tbody"))) : N; }
        }
    };
    ...
    n.extend({
        ...
        isFunction: function(D) { return r.call(D) === "[object Function]"; },
        isArray: function(D) { return r.call(D) === "[object Array]"; },
        isXMLDoc: function(D) { return D.documentElement && !D.body || D.tagName && D.ownerDocument && !D.ownerDocument.body; },
        ...
        className: {
            ...
            remove: function(D, E) {
                if (D.nodeType == 1) {
                    D.className = E !== g ? n.grep(D.className.split(/\s+/), function(F) { return !n.className.has(E, F); }).join(" ") : "";
                }
            },
            has: function(E, D) { return n.inArray(D, (E.className || E).toString().split(/\s+/)) > -1; }
        },
        swap: function(G, F, H) {
            var D = {};
            for (var E in F) {
        ...
        curCSS: function(H, E, F) {
            ...
            if (!F && D && D[E]) {
                ...
                if (p.getComputedStyle) {
                    ...
                    if (H.currentStyle) {
                        var I = E.replace(/\-(\w)/g, function(M, N) { return N.toUpperCase(); });
        ...
        clean: function(E, J, H) {
            ...
            n.each(E, function(O, Q) {
                ...
                if (typeof Q === "string") {
                    Q = Q.replace(/(<(\w+)[^>]*?)\/>/g, function(S, T, R) { return R.match(/^(abbr|br|col|img|input|link|meta|param|hr|area|embed)$/i) ? S : T + "></" + R + ">"; });
        ...
        attr: function(I, F, J) {
            ...
            F = F.replace(/-([a-z])/ig, function(L, M) { return M.toUpperCase(); });
            if (K) {
                I[F] = J;
            }
            return I[F];
    ...
    n.each({ parent: function(D) { return D.parentNode; }, parents: function(D) { return n.dir(D, "parentNode"); }, next: function(D) { return n.nth(D, 2, "nextSibling"); }, prev: function(D) { return n.nth(D, 2, "previousSibling"); }, nextAll: function(D) { return n.dir(D, "nextSibling"); }, prevAll: function(D) { return n.dir(D, "previousSibling"); }, siblings: function(D) { return n.sibling(D.parentNode.firstChild, D); }, children: function(D) { return n.sibling(D.firstChild); }, contents: function(D) { return n.nodeName(D, "iframe") ? D.contentDocument || D.contentWindow.document : n.makeArray(D.childNodes); } }, function(D, E) {
        n.fn[D] = function(F) {
            var G = n.map(this, E);
    ...
    n.each({
        ...
        addClass: function(D) { n.className.add(this, D); },
        removeClass: function(D) { n.className.remove(this, D); },
    ...
    }, function(D, E) { n.fn[D] = function() { return this.each(E, arguments); }; });

    function j(D, E) { return D[0] && parseInt(n.curCSS(D[0], E, true), 10) || 0; }
    ...
    n.fn.extend({
        data: function(D, F) {
            ...
            if (F === g) {
                ...
                return this.trigger("setData" + G[1] + "!", [G[0], F]).each(function() { n.data(this, D, F); });
            }
        },
        ...
        dequeue: function(D) { return this.each(function() { n.dequeue(this, D); }); }
    });
/*
 ...
 */
    (function() {
        ...
        E.matches = function(P, Q) { return E(P, null, null, Q); };
        E.find = function(V, S) {
            var W, Q;
            if (!V) {
                return[];
        ...
        var G = E.selectors = {
            ...
            find: {
                ...
                NAME: function(P, Q) { return Q.getElementsByName ? Q.getElementsByName(P[1]) : null; },
            ...
            filters: {
                enabled: function(P) { return P.disabled === false && P.type !== "hidden"; },
                ...
                has: function(R, Q, P) { return !!E(P[3], R).length; },
            ...
            setFilters: { first: function(Q, P) { return P === 0; }, last: function(R, Q, P, S) { return Q === S.length - 1; }, even: function(Q, P) { return P % 2 === 0; }, odd: function(Q, P) { return P % 2 === 1; }, lt: function(R, Q, P) { return Q < P[3] - 0; }, gt: function(R, Q, P) { return Q > P[3] - 0; }, nth: function(R, Q, P) { return P[3] - 0 == Q; }, eq: function(R, Q, P) { return P[3] - 0 == Q; } },
            filter: {
                CHILD: function(P, S) {
                ...
                CLASS: function(Q, P) { return P.test(Q.className); },
                ATTR: function(T, R) {
        ...
        (function() {
            ...
            if (P.firstChild.getAttribute("href") !== "#") {
                G.attrHandle.href = function(Q) { return Q.getAttribute("href", 2); };
            }
        })();
        ...
        if (document.documentElement.getElementsByClassName) {
            ...
            G.find.CLASS = function(P, Q) { return Q.getElementsByClassName(P[1]); };
        }
        ...
        var H = document.compareDocumentPosition ? function(Q, P) { return Q.compareDocumentPosition(P) & 16; } : function(Q, P) { return Q !== P && (Q.contains ? Q.contains(P) : true); };
        var M = function(P) { return P.documentElement && !P.body || P.tagName && P.ownerDocument && !P.ownerDocument.body; };
        n.find = E;
        n.filter = E.filter;
        n.expr = E.selectors;
        n.expr[":"] = n.expr.filters;
        E.selectors.filters.hidden = function(P) { return"hidden" === P.type || n.css(P, "display") === "none" || n.css(P, "visibility") === "hidden"; };
        E.selectors.filters.visible = function(P) { return"hidden" !== P.type && n.css(P, "display") !== "none" && n.css(P, "visibility") !== "hidden"; };
        E.selectors.filters.animated = function(P) { return n.grep(n.timers, function(Q) { return P === Q.elem; }).length; };
    ...
    n.event = {
        add: function(H, E, G, J) {
            ...
            var D = n.data(H, "events") || n.data(H, "events", {}), I = n.data(H, "handle") || n.data(H, "handle", function() { return typeof n !== "undefined" && !n.event.triggered ? n.event.handle.apply(arguments.callee.elem, arguments) : g; });
            I.elem = H;
        ...
        proxy: function(E, D) {
            D = D || function() { return E.apply(this, arguments); };
        ...
        specialAll: {
            live: {
                setup: function(D, E) { n.event.add(this, E[0], c); },
                teardown: function(F) {
                    if (F.length) {
    ...
    n.each({ mouseover: "mouseenter", mouseout: "mouseleave" }, function(E, D) { n.event.special[D] = { setup: function() { n.event.add(this, E, a, D); }, teardown: function() { n.event.remove(this, E, a); } }; });
    n.fn.extend({
        bind: function(E, F, D) { return E == "unload" ? this.one(E, F, D) : this.each(function() { n.event.add(this, E, D || F, D && F); }); },
        one: function(F, G, E) {
            var D = n.event.proxy(E || G, function(H) {
                n(this).unbind(H, D);
                return(E || G).apply(this, arguments);
            });
            return this.each(function() { n.event.add(this, F, D, E && G); });
        },
        unbind: function(E, D) { return this.each(function() { n.event.remove(this, E, D); }); },
        trigger: function(D, E) { return this.each(function() { n.event.trigger(D, E, this); }); },
        ...
        hover: function(D, E) { return this.mouseenter(D).mouseleave(E); },
        ready: function(D) {
            A();
            if (n.isReady) {
                D.call(document, n);
    ...
    function i(E, D) { return["live", E, D.replace(/\./g, "`").replace(/ /g, "|")].join("."); }
    ...
    n.extend({
        ...
        ready: function() {
            if (!n.isReady) {
                n.isReady = true;
                if (n.readyList) {
                    n.each(n.readyList, function() { this.call(document, n); });
                    n.readyList = null;
                }
    ...
    n.each(("blur,focus,load,resize,scroll,unload,click,dblclick,mousedown,mouseup,mousemove,mouseover,mouseout,mouseenter,mouseleave,change,select,submit,keydown,keypress,keyup,error").split(","), function(E, D) { n.fn[D] = function(F) { return F ? this.bind(D, F) : this.trigger(D); }; });
    ...
    n.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() { return this.elements ? n.makeArray(this.elements) : this; }).filter(function() { return this.name && !this.disabled && (this.checked || /select|textarea/i.test(this.nodeName) || /text|hidden|password/i.test(this.type)); }).map(function(D, E) {
                var F = n(this).val();
                return F == null ? null : n.isArray(F) ? n.map(F, function(H, G) { return{ name: E.name, value: H }; }) : { name: E.name, value: F };
            }).get();
        }
    });
    n.each("ajaxStart,ajaxStop,ajaxComplete,ajaxError,ajaxSuccess,ajaxSend".split(","), function(D, E) { n.fn[E] = function(F) { return this.bind(E, F); }; });
    var q = e();
    n.extend({
        ...
        getScript: function(D, E) { return n.get(D, null, E, "script"); },
        getJSON: function(D, E, F) { return n.get(D, E, F, "json"); },
        ...
        ajaxSetup: function(D) { n.extend(n.ajaxSettings, D); },
        ...
        param: function(D) {
            ...
            function G(H, I) { F[F.length] = encodeURIComponent(H) + "=" + encodeURIComponent(I); }

            if (n.isArray(D) || D.jquery) {
                n.each(D, function() { G(this.name, this.value); });
            } else {
                for (var E in D) {
                    if (n.isArray(D[E])) {
                        n.each(D[E], function() { G(E, this); });
                    } else {
    ...
    function s(E, D) {
        var F = {};
        n.each(d.concat.apply([], d.slice(0, D)), function() { F[this] = E; });
        return F;
    }
    ...
    n.fn.extend({
        ...
        fadeTo: function(D, F, E) { return this.animate({ opacity: F }, D, E); },
    ...
    n.each({ slideDown: s("show", 1), slideUp: s("hide", 1), slideToggle: s("toggle", 1), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" } }, function(D, E) { n.fn[D] = function(F, G) { return this.animate(E, F, G); }; });
    n.extend({
        ...
        easing: { linear: function(F, G, D, E) { return D + E * F; }, swing: function(F, G, D, E) { return((-Math.cos(F * Math.PI) / 2) + 0.5) * E + D; } },
        timers: [],
        timerId: null,
        fx: function(E, D, F) {
            this.options = D;
    ...
    n.extend(n.fx, {
        ...
        step: {
            opacity: function(D) { n.attr(D.elem.style, "opacity", D.now); },
            _default: function(D) {
    ...
    n.each(["Left", "Top"], function(E, D) {
        ...
        n.fn[F] = function(G) {
            ...
            return G !== g ? this.each(function() { this == l || this == document ? l.scrollTo(!E ? G : n(l).scrollLeft(), E ? G : n(l).scrollTop()) : this[F] = G; }) : this[0] == l || this[0] == document ? self[E ? "pageYOffset" : "pageXOffset"] || n.boxModel && document.documentElement[F] || document.body[F] : this[0][F];
        };
    });
    n.each(["Height", "Width"], function(G, E) {
        var D = G ? "Left" : "Top", F = G ? "Right" : "Bottom";
        n.fn["inner" + E] = function() { return this[E.toLowerCase()]() + j(this, "padding" + D) + j(this, "padding" + F); };
        n.fn["outer" + E] = function(I) { return this["inner" + E]() + j(this, "border" + D + "Width") + j(this, "border" + F + "Width") + (I ? j(this, "margin" + D) + j(this, "margin" + F) : 0); };
        var H = E.toLowerCase();
        n.fn[H] = function(I) { return this[0] == l ? document.compatMode == "CSS1Compat" && document.documentElement["client" + E] || document.body["client" + E] : this[0] == document ? Math.max(document.documentElement["client" + E], document.body["scroll" + E], document.documentElement["scroll" + E], document.body["offset" + E], document.documentElement["offset" + E]) : I === g ? (this.length ? n.css(this[0], H) : null) : this.css(H, typeof I === "string" ? I : I + "px"); };
    });
})();