...
ChiliBook.recipes["html.js"] =
{
    steps: {
        ...
        php: { exp: /(?:\<\?php\s)|(?:\<\?)|(?:\?\>)/ },
        aname: { exp: /\s+?[\w-]+:?\w+(?=\s*=)/ },
        avalue: { exp: /(=\s*)(([\"\'])(?:(?:[^\3\\]*?(?:\3\3|\\.))*?[^\3\\]*?)\3)/, replacement: '$1<span class="$0">$2</span>' },
        entity: { exp: /&[\w#]+?;/ }
    }
};
...
ChiliBook.recipes["mysql.js"] =
{
    ...
    steps: {
        ...
        op: { exp: /!=|&&|<|<<|<=|<=>|<>|=|>|>=|>>|\|\|/ },
        variable: { exp: /@([$.\w]+|([`\"\'])(?:(?:[^\2\\\r\n]*?(?:\2\2|\\.))*[^\2\\\r\n]*?)\2)/, replacement: '<span class="keyword">@</span><span class="variable">$1</span>' },
...
ChiliBook.recipes["php.js"] =
{
    steps: {
        ...
        variable: { exp: /\$(\w+)/, replacement: '<span class="keyword">$</span><span class="variable">$1</span>' },
        heredoc: { exp: /(\<\<\<\s*)(\w+)((?:(?!\2).*\n)+)(\2)\b/, replacement: '<span class="keyword">$1</span><span class="string1">$2</span><span class="string2">$3</span><span class="string1">$4</span>' }
    }
};
