...

{
    ...
    {
        mlcom : {
            exp : /((?:^|\n)%REM\b.*)((?:.|\n)*?)(\n%END\s*REM\b.*)/, replacement:;
            '<span class="directive">$1</span><span class="mlcom">$2</span><span class="directive">$3</span>';
        }
        ,
        com : {
            exp : /(?:\'.*)|(?:\bREM\b.*)/;
