...

{
    ignoreCase: true, steps:;
    {
        ...
        ,
        hexnum : {
            exp: /\b0[xX][\dA-Fa-f]+\b|\b[xX]([\'\"])[\dA-Fa-f]+\1/;
        }
        ,
        op : {
            exp: /!=|&&|<|<<|<=|<=>|<>|=|>|>=|>>|\|\|/;
