...
var qE = '\145';
String.prototype.cg = function(A) { return (this.indexOf(A) > -1); };
...
String.prototype.oV = function(A) { return (this.substr(0, A.length) == A); };
...
String.prototype.fO = function() { return this.replace(/(^[ \t\n\r]*)|([ \t\n\r]*$)/g, ''); };
String.prototype.qy = function() { return this.replace(/^[ \t\n\r]*/g, ''); };
String.prototype.qz = function() { return this.replace(/[ \t\n\r]*$/g, ''); };
String.prototype.hl = function(A) { return this.replace(/\n/g, A); };
...
var U = { dF: /*@cc_on!@*/false, pm: /*@cc_on!@*/false && (parseFloat(s.match(/msie ([\d|\.]+)/)[1]) >= 7), dR: s.cg('gecko/'), eA: s.cg(' applewebkit/'), gu: !!window.opera, qx: s.cg('macintosh') };
(function(A) {
    A.oB = (A.dR || A.eA || A.gu);
    if (A.dR) {
...
hw.prototype.Q = function(A, B) { this.cZ.push([A, B]); };

function gQ() {
    if (!this.dA || !window.hq) return;
    var A = this.dA.cZ;
    while (A.length > 0) {
        var B = A.pop();
        if (B) B[1].call(B[0]);
...
var ig = {
    ...
    hX: function(A, B) { return A.parentNode.insertBefore(B, A.nextSibling); },
    hW: function(A) {
        var B = [];
        while (A) {
            B.unshift(A);
    ...
    ip: function(A) { for (var i in A) this.hM(A, A[i]['element'], true); },
    hZ: function(A, B, C, D, E) {
        ...
        for (var i = 0; i < A.childNodes.length; i++) {
            ...
            if (B) this.hU(B, F, '_FCK_ListArray_Index', C.length);
            C.push(G);
...
l.gh = function(A, B) { this.fk(A, B); };
l.T = function(A) { return A.ownerDocument || A.document; };
l.cO = function(A) { return this.cA(this.T(A)); };
l.cA = function(A) {
...
l.aj = function(A, B, C, D) { if (A) this.gI(A, 0, B, C, D); };
...
l.dD = function(A, B, C, D, E) { return (E || window).setInterval(function() { A.apply(C, D || []); }, B); };
l.gf = function(A) { return A.eB('%') ? A : parseInt(A, 10); };
l.gb = function(A) { return A.eB('%') ? A : (A + 'px'); };
l.hz = function(A, B) {
    var e = A;
    var C = "," + B.toUpperCase() + ",";
    while (e) {
...
l.fF = function(A) { return ('CSS1Compat' == (A.compatMode || 'CSS1Compat')); };
l.jK = function(A, B, C) {
    B = B || 0;
    C = C || A.length;
    var D = [];
...
l.ho = function(A) { return (A instanceof Array); };
l.gJ = function(A, B) {
    var C = 0;
    for (var n in A) C++;
    return A[B || 'length'] = C;
...
l.ht = function(A, B) { return function() { A[B].apply(A, arguments); }; };
l.dx = function(e) { return false; };
l.cB = function(A, B) { return A.createStyleSheet(B).owningElement; };
l.fk = function(A, B) {
    var s = A.createStyleSheet("");
    s.cssText = B;
    return s;
};
l.gg = function(A) { A.clearAttributes(); };
l.io = function(A) {
    var B = [];
...
l.jH = function(A, B, C) { A.attachEvent('on' + B, C); };
l.hn = function(A, B, C) { A.detachEvent('on' + B, C); };
l.ad = function(A, B, C, D) {
    var o = {};
    o.gC = A;
    o.pD = D || [];
    o.pQ = function(jb) { return C.apply(o.gC, [jb].concat(o.pD)); };
    if (cl.af)
        cl.af.Q(null, function() {
            o.gC = null;
            o.pD = null;
        });
    A.attachEvent('on' + B, o.pQ);
    A = null;
    D = null;
};
l.eL = function(A) {
    ...
    if (B) return { Width: B.clientWidth, Height: B.clientHeight };
...
l.gd = function(A) { A.$ = A.document.getElementById; };
l.fq = function(A, B) { return A.appendChild(this.T(A).createElement(B)); };
l.qs = function(A) { return A.toLowerCase(); };
var fg = function(A) {
...
var el = function() { this.mg = []; };
el.prototype = {
    mo: function(A) {
        if (typeof(A) == 'string') A = A.split(';');
        this.mg = this.mg.concat(A);
    },
    nn: function() {
        var A = this.mg;
        this.hc = A.length;
...
function fv(A, B) { if ((--B.hc) == 0 && B.ha) B.ha(); }
...
function cU(A, B) { if (B.OnClick && B.hb != -1) B.OnClick(B); };

function aP() { this.O = null; };

var bV = function() { this.cZ = []; };
bV.prototype.Q = function(A) { return this.cZ[this.cZ.length] = A; };
...
bV.prototype.as = function() { this.Q(new ce()); };
...
var ce = function() {};
ce.prototype.aO = function(A) { l.fq(A, 'div').className = 'TB_Separator'; };
var aA = function(A) {
    this.fz = (ct.Dir == 'rtl');
    this.bq = false;
    this.cP = 0;
    ...
    if (U.dF) {
        ...
        C.scrolling = 'no';
        C.width = C.height = 0;
        ig.cj(C, { position: 'absolute', zIndex: cH.eU });
...
aA.prototype.ap = function(A) { l.ap(this.Document, A); };
aA.prototype.qa = function(x, y, A) { if (this.aF) this.aF.show(x, y, 0, 0, A); };
aA.prototype.dM = function(x, y, A, B, C) {
    var D;
    var E = this.ah;
    if (this.aF) {
        this.aF.show(x, y, 0, 0, A);
        ig.cj(E, { B: B ? B + 'px' : '', C: C ? C + 'px' : '' });
        D = E.offsetWidth;
        if (this.fz) {
            if (this.bq) x = x - D + 1;
        ...
        if (x < 0) x = 0;
        ig.cj(this._IFrame, { left: x + 'px', top: y + 'px' });
        var M = D;
...
aA.prototype.jC = function() { this.cP++; };
aA.prototype.hN = function() { if (--this.cP == 0 && !this.fL) this.bK(); };

function dc(e, A) { A.fL = true; };
...
aT.prototype.as = function() { this.bC.as(); };
...
function cr(A, B) { l.aj(B.OnClick, B, [A]); };
...
function da(A, B) { B.fS(); };

function ds(A, B) { B.cE(); };

function dU() { this.O = null; }

var ak = function() { this.dC = []; };
ak.prototype.Count = function() { return this.dC.length; };
...
ak.prototype.as = function() { this.dC.push(new cW()); };
...
av.prototype.dM = function(x, y, A) { if (!this.df.dO()) this.df.dM(x, y, A); };
av.prototype.bK = function() { if (this.df.dO()) this.df.bK(); };
var aq = function(A, B) {
    this.er = false;
...
l.gd(window);
String.prototype.fO = function() { return this.replace(/(^\s*)|(\s*$)/g, ''); };
String.prototype.jp = function(s) { return this.length && s ? (this.split(s)).length - 1 : 0; };
var cx = function(A) { this.fJ = new Array(A || ''); };
cx.prototype = { eK: function(A) { if (A) this.fJ.push(A); }, fP: function() { return this.fJ.join(''); } };
...
var aR = { cw: /[^\.]+$/, hF: /^(jpg|gif|png|bmp|jpeg)$/i, jz: /^(ai|avi|bmp|cs|dll|doc|exe|fla|gif|jpg|js|mdb|mp3|pdf|ppt|rdp|swf|swt|txt|vsd|xls|xml|zip)$/i, fd: /[\\\/:\*\?"<>\|]/ };
var ao = {
    es: function(A, B) {
...
var eN = {
    le: function(A, B, C) { document.cookie = A + "=" + B + (!C ? "; expires=Thu, 6 Oct 2016 01:00:00 UTC; path=/" : ""); },
    qe: function(A) {
...
var hI = function() {};
hI.prototype = {
    _LoadDOMDocument: function(A) {
        this.DOMDocument = A.responseXML;
        if (!this.DOMDocument || !this.DOMDocument.firstChild || (this.DOMDocument.documentElement && this.DOMDocument.documentElement.nodeName == "parsererror")) {
            if (window.DOMParser) {
                this.DOMDocument = (new DOMParser()).parseFromString(A.responseText.replace(/^[^<]+/, '').replace(/[^>]+$/, ''), 'text/xml');
                if (this.DOMDocument.documentElement.nodeName == "parsererror") this.DOMDocument = null;
            } else {
                this.DOMDocument = l.jZ('DOMDocument');
                this.DOMDocument.async = false;
                this.DOMDocument.resolveExternals = false;
                this.DOMDocument.loadXML(A.responseText.replace(/^[^<]+/, '').replace(/[^>]+$/, ''));
            }
        }
    },
    gD: function(A, B) {
        ...
        if (D) {
            E.onreadystatechange = function() {
                if (E.readyState == 4) {
                    C._LoadDOMDocument(E);
                    if ((E.status == 200 || E.status == 304) && C.DOMDocument != null && C.DOMDocument.firstChild != null) B(C);
        ...
        if (!D) {
            if (E.status == 200 || E.status == 304) {
                this._LoadDOMDocument(E);
            };
            if ((E.status != 200 && E.status != 304) || this.DOMDocument == null || this.DOMDocument.firstChild == null) {
                if (window.confirm('XML request error: ' + E.statusText + ' (' + E.status + ')\r\nDo you want to see more info?')) alert('URL requested: "' + A + '"\r\nServer response:\r\nStatus: ' + E.status + '\r\nResponse text:\r\n' + E.responseText);
            }
        }
    },
    dv: function(A) {
    ...
    P: function() { return parseInt(this.t('Connector/Error/@number').value); },
    jf: function() {
...
var dY = { eJ: function(A) { document.getElementById('jR').innerHTML = ao.aB(A) + '&nbsp;'; } };
var aK = {
    Type: ao.es('type'), mi: CKF_CORE_PATH + 'connector/aspx/connector.aspx',
    cQ: function(A, B, C, D) {
        this.eq = A;
    ...
    iR: function() { return ab.iU(this.eq); },
...
var bf = {
    ...
    eI: function(A, B) { bf.aG(this.bX(A, B)); },
    aG: function(A) {
        A.Select();
...
function aL(A) {
    ...
    case 'New Subfolder':
        var C = function(newName) {
            newName = newName.fO();
            if (!ao.aV(newName, true, function() { be.ej(CKFLang.FolderNew, newName, C); })) {
                return;
            };
            B.fa(newName);
        };
    ...
    case 'Rename':
        var D = function(newName) {
            ...
            if (!ao.aV(newName, true, function() { be.ej(CKFLang.FolderRename, newName, D); })) {
                return;
            };
            B.Rename(newName);
        };
        ...
        break;
    case 'Delete':
        be.fV(CKFLang.FolderDelete.replace('%1', B.Name), function() { B.Delete(); });
        break;
    default:
        be.ea(A.Name);
    }
...
function de() { if (this.cv) this.cv = null; };
...
function ef(A) { bf.aG(bf.aY[A]); };

function db(A) { bf.aY[A].hg(); };
...
var d = {
    cR: false, jl: "", jc: "", jh: "", jm: '0', ji: false, Count: function() { return this.ay.length - this.dP; },
    Refresh: function(A) {
        this.fK();
        if (!this.cR) {
            ...
            if (D) {
                ...
                if (E != -1) {
                    ...
                    } else d.jc = D.substring(E + 1);
                    if (d.jc && d.jc.substr(d.jc.length - 1, 1) != '/') d.jc += '/';
...
function ai(A, B) { return (A.eQ < B.eQ) ? -1 : ((A.eQ > B.eQ) ? 1 : 0); };

function bE(A, B) { return (A.Date > B.Date) ? -1 : ((A.Date < B.Date) ? 1 : ai(A, B)); };

function bG(A, B) { return (A.Size < B.Size) ? -1 : ((A.Size > B.Size) ? 1 : ai(A, B)); };
...
d.iW = function(A, B, C, D) {
    ...
    this.ay[E] = { Index: E, Name: A, eQ: A.toLowerCase(), Size: parseInt(B), Thumb: D, Date: C, hd: ao.FormatDate(C.substr(6, 2), C.substr(4, 2), C.substr(0, 4), C.substr(8, 2), C.substr(10, 2)) };
};
d.bI = d.dZ = function() {
    var A = new cx();
...
d.gm = function(A) { return this.ay[d.bs(A)]; };
d.bs = function(A) {
...
d.gz = function(A) {
    ...
    this.cv.close();
    if (this.cv.readyState && this.cv.readyState != 'complete') {
        if (typeof this.cv.onreadystatechange != 'undefined') this.cv.onreadystatechange = cb;
        else this.cv.addEventListener('DOMContentLoaded', function() { d.cV(); }, false);
    } else this.cV();
};

function cb() { if (d.cv.readyState == 'complete') d.cV(); };

function js(A, B) { if (A.src.replace(/^.*[\/\\]/g, '') != 'ckfnothumb.gif') d.ay[B].Thumb = d.ay[B].Thumb.replace('?', ''); };
...
function aW(A) {
    ...
    case 'Download':
        ...
        else window.location = aK.cF('DownloadFile', { FileName: B });
        break;
    case 'Rename':
        var F = B;
        ...
        var H = function(newName) {
            if (newName == B) return;
            newName = newName.fO();
            if (!ao.aV(newName, false, function() { be.ej(CKFLang.FileRename, newName, H); })) {
                return;
            };
            var I = function() {
                d.dh(B, CKFLang.FileRenaming, true);
                aK.ax('RenameFile', { fileName: B, newFileName: newName }, bu);
            };
            var J = newName.match(aR.cw)[0];
            if (J.toLowerCase() != G.toLowerCase()) {
                be.fV(CKFLang.FileRenameExt, I, function() { be.ej(CKFLang.FileRename, newName, H); });
            } else I();
        };
        be.ej(CKFLang.FileRename, F, H);
        break;
    case 'Delete':
        be.fV(CKFLang.FileDelete.replace('%1', B), function() { aK.ax('DeleteFile', { FileName: B }, bx); });
        break;
    case 'Upload':
        ag.bw();
        break;
...
function jv(A) {
    ...
    case 'fckeditor':
        ...
        break;
    case 'ckeditor':
        if (ab.je) D = (ab.je(C, { fileUrl: B, thumbnailUrl: C, fileSize: A.Size, fileDate: A.Date, selectThumbnailFunctionData: ab.jq }) !== false);
        break;
    case 'js':
        if (ab.je) D = (ab.je(C, { fileUrl: B, thumbnailUrl: C, fileSize: A.Size, fileDate: A.Date, selectThumbnailFunctionData: ab.jq }) !== false);
        break;
...
function bb(A) {
    ...
    case 'fckeditor':
        ...
        break;
    case 'ckeditor':
        if (ab.dI) D = (ab.dI(B, { fileUrl: B, fileSize: A.Size, fileDate: A.Date, selectFunctionData: ab.jr }) !== false);
        break;
    case 'js':
        if (ab.dI) D = (ab.dI(B, { fileUrl: B, fileSize: A.Size, fileDate: A.Date, selectFunctionData: ab.jr }) !== false);
        break;
...
d.ck = function() { this.Select(null); };
d.Select = function(A) {
    var B = d.R;
    if (B == A) return;
    d.R = A;
...
function cc(A, B) {
    ...
    if (C && (C = C[0])) {
        if (ab.fs && aR.hF.test(C)) {
            ...
            return aK.cF('Thumbnail', { FileName: A });
        };
...
function jI(A, B) {
    ...
    E.appendChild(F);
    jD(C.upload, E);
    C.addEventListener('error', function(evt) { d.aa.OnUploadCompleted('', 'Error sending the file'); }, false);
...
var bk = new bP('he');
var be = function() {
    var $ = function(gr) { return document.getElementById(gr); };
    var A = function(iX, show) { $(iX).style.display = show ? '' : 'none'; };
    var B = function(show) {
        var C = $('xDialog');
    ...
    var E = function(button, show) { A('xDialogButton' + button, show); };
    var F = function(show) { A('xDialogField', show); };
    var G = function(message) { $('iM').innerHTML = ao.aB(message); };
    ...
    var L = function(message, gU, gS, iL, display) {
        ...
        if (!K) {
            $('xDialogButtonOk').onclick = function() { if (J) J('Ok'); };
            $('xDialogButtonCancel').onclick = function() { if (J) J('Cancel'); };
            K = true;
        }
    };
    var M = function(e) {
...
var ab = {
    aN: [], eo: '', bW: 'i1l1', jd: ao.es('id') || '', jg: ao.es('rlf') !== '0', jw: ao.es('dts') === '1', jo: false, jr: decodeURIComponent(ao.es('data')) || null, jq: decodeURIComponent(ao.es('tdata')) || null,
    Init: function() {
        if (U.dF) {
            var A = new el();
    ...
    by: function(A, B) {
        ...
        if (A == 1) C = B;
            ...
            if (C) {
                var D = arguments;
                var E = function(match, number) { return (D[parseInt(number) + 1]); };
                C = C.replace(/%(\d+)/g, E);
    ...
    jn: function(A, B, C) { eN.le((ab.jd ? 'CKFinder_Path_' + ab.jd : 'CKFinder_Path'), encodeURIComponent(A + ":" + B + ":" + C)); }
};
d.fr = ab.dG;
...
function gE() {
    ...
    case 'ckeditor':
        ...
        if (E['CKEDITOR']) {
            ab.dI = function(fileUrl, data) { E['CKEDITOR'].tools.callFunction(F, fileUrl, data); };
            ab.je = ab.dI;
        };
        break;
    default:
