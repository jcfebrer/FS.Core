...
l.dx = function(e) { if (e) e.preventDefault(); };
l.cS = function(A) {
...
l.ek = function(A) { return { X: A.pageXOffset, Y: A.pageYOffset }; };
l.jH = function(A, B, C) { A.addEventListener(B, C, false); };
l.hn = function(A, B, C) { A.removeEventListener(B, C, false); };
l.ad = function(A, B, C, D) { A.addEventListener(B, function(e) { C.apply(A, [e].concat(D || [])); }, false); };
l.eL = function(A) { return { Width: A.innerWidth, Height: A.innerHeight }; };
l.ph = function(A) {
    var B = l.dN(A);
    var C = {};
...
l.gd = function(A) { A.$ = function(id) { return this.document.getElementById(id); }; };
l.fq = function(A, B) { return A.appendChild(A.ownerDocument.createElement(B)); };
l.fn = function(A, B) {
    var c = { X: 0, Y: 0 };
    var C = B || window;
    var D = l.cO(A);
