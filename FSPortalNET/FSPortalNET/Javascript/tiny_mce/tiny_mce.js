(function(c) {
    ...
    var b = {
        ...
        trim: function(e) { return(e ? "" + e : "").replace(a, ""); },
        create: function(m, e) {
            ...
            if (m[5]) {
                ...
                g = h[i];
                if (k) {
                    h[i] = function() { return f[j].apply(this, arguments); };
                } else {
                    h[i] = function() {
                        this.parent = f[j];
                ...
                h[i].prototype[i] = h[i];
                l.each(f, function(o, p) { h[i].prototype[p] = f[p]; });
            ...
            l.each(e["static"], function(o, p) { h[i][p] = o; });
            if (this.onCreate) {
        ...
        explode: function(e, f) { return e ? b.map(e.split(f || ","), b.trim) : e; },
        _addVer: function(f) {
            var e;
            if (!this.query) {
                return f;
...
(function(e, d) {
    ...
    d.adapter = {
        patchEditor: function(j) {
            ...
            function g(n, o) {
                ...
                if (b.test(n)) {
                    if (o !== f) {
                        m.each(function(p, q) { j.dom.setAttrib(q, n, o); });
                        return m;
                    } else {
            ...
            function l(m) {
                if (m.css !== h) {
                    ...
                    m.tinymce = j;
                    m.pushStack = function() { return l(i.pushStack.apply(this, arguments)); };
                }
                return m;
            }
    ...
    d.extend = e.extend;
    d.extend(d, { map: e.map, grep: function(g, h) { return e.grep(g, h || function() { return 1; }); }, inArray: function(g, h) { return e.inArray(h, g || []); } });
    var a = {
        "tinymce.dom.DOMUtils": {
            ...
            is: function(h, g) { return e(this.get(h)).is(g); }
        }
    };
    d.onCreate = function(g, i, h) { d.extend(h, a[i]); };
...
(function() {
    ...
    tinymce.create("static tinymce.util.Cookie", {
        ...
        set: function(i, b, g, f, h, c) { document.cookie = i + "=" + escape(b) + ((g) ? "; expires=" + g.toGMTString() : "") + ((f) ? "; path=" + escape(f) : "") + ((h) ? "; domain=" + h : "") + ((c) ? "; secure" : ""); },
        remove: function(e, b) {
            var c = new Date();
...
(function(m) {
    ...
    m.create("tinymce.dom.DOMUtils", {
        ...
        props: { "for": "htmlFor", "class": "className", className: "className", checked: "checked", disabled: "disabled", maxlength: "maxLength", readonly: "readOnly", selected: "selected", value: "value", id: "id", name: "name", type: "type" },
        DOMUtils: function(u, q) {
            ...
            p.settings = q = m.extend({ keep_values: false, hex_colors: 1, process_html: 1 }, q);
            if (m.isIE6) {
                try {
            ...
            if (q.valid_styles) {
                p._styles = {};
                k(q.valid_styles, function(t, s) { p._styles[s] = m.explode(t); });
            }
        ...
        getViewPort: function(p) {
            ...
            return{ x: p.pageXOffset || o.scrollLeft, y: p.pageYOffset || o.scrollTop, w: p.innerWidth || o.clientWidth, h: p.innerHeight || o.clientHeight };
        },
        getRect: function(s) {
            var r, o = this, q;
            s = o.get(s);
            r = o.getPos(s);
            q = o.getSize(s);
            return{ x: r.x, y: r.y, w: q.w, h: q.h };
        },
        getSize: function(r) {
            var p = this, o, q;
            r = p.get(r);
            ...
            return{ w: parseInt(o) || r.offsetWidth || r.clientWidth, h: parseInt(q) || r.offsetHeight || r.clientHeight };
        },
        getParent: function(q, p, o) { return this.getParents(q, p, o, false); },
        getParents: function(z, v, s, y) {
            ...
            if (j(v, "string")) {
                p = v;
                if (v === "*") {
                    v = function(o) { return o.nodeType == 1; };
                } else {
                    v = function(o) { return q.is(o, p); };
                }
            }
            while (z) {
        ...
        getNext: function(p, o) { return this._findSib(p, o, "nextSibling"); },
        getPrev: function(p, o) { return this._findSib(p, o, "previousSibling"); },
        ...
        create: function(q, o, p) { return this.add(this.doc.createElement(q), q, o, p, 1); },
        ...
        setStyle: function(r, o, p) {
            ...
            return q.run(r, function(v) {
                var u, t;
                u = v.style;
                o = o.replace(/-(\D)/g, function(x, s) { return s.toUpperCase(); });
        ...
        getStyle: function(r, o, q) {
            ...
            if (this.doc.defaultView && q) {
                o = o.replace(/[A-Z]/g, function(s) { return"-" + s; });
                try {
            ...
            o = o.replace(/-(\D)/g, function(t, s) { return s.toUpperCase(); });
            if (o == "float") {
        ...
        setStyles: function(u, v) {
            ...
            p = r.update_styles;
            r.update_styles = 0;
            k(v, function(o, s) { q.setStyle(u, s, o); });
            r.update_styles = p;
            if (r.update_styles) {
        ...
        setAttrib: function(q, r, o) {
            ...
            return this.run(q, function(u) {
                ...
                case"style":
                    if (!j(o, "string")) {
                        k(o, function(s, x) { p.setStyle(u, x, s); });
                        return;
                    }
                    if (t.keep_values) {
                        if (o && !p._isRes(o)) {
        ...
        setAttribs: function(q, r) {
            var p = this;
            return this.run(q, function(o) { k(r, function(s, t) { p.setAttrib(o, t, s); }); });
        },
        ...
        getPos: function(A, s) {
            ...
            if (A) {
                if (d && !p.stdMode) {
                    ...
                    return{ x: A.left + u.scrollLeft - o, y: A.top + u.scrollTop - o };
                }
                q = A;
        ...
        parseStyle: function(r) {
            ...
            k(r.split(";"), function(s) {
                ...
                if (s) {
                    ...
                    s = s.split(":");
                    o = m.trim(s[1]);
                    o = o.replace(/url\(([^\)]+)\)/g, function(z, y) { return t[parseInt(y) - 1]; });
                    o = o.replace(/rgb\([^\)]+\)/g, function(y) { return u.toHex(y); });
                    if (v.url_converter) {
                        o = o.replace(/url\([\'\"]?([^\)\'\"]+)[\'\"]?\)/g, function(y, z) { return"url(" + v.url_converter.call(v.url_converter_scope || u, u.decode(z), "style", null) + ")"; });
                    }
        ...
        serializeStyle: function(v, p) {
            ...
            if (p && q._styles) {
                k(q._styles["*"], function(o) { u(v[o], o); });
                k(q._styles[p.toLowerCase()], function(o) { u(v[o], o); });
            } else {
                k(v, u);
            }
            return r;
        ...
        loadCSS: function(o) {
            ...
            k(o.split(","), function(s) {
                ...
                q.files[s] = true;
                t = q.create("link", { rel: "stylesheet", href: m._addVer(s) });
                if (d && r.documentMode) {
                    t.onload = function() {
                        r.recalc();
                        t.onload = null;
        ...
        show: function(o) { return this.setStyle(o, "display", "block"); },
        hide: function(o) { return this.setStyle(o, "display", "none"); },
        isHidden: function(o) {
            o = this.get(o);
            return !o || o.style.display == "none" || this.getStyle(o, "display") == "none";
        },
        uniqueId: function(o) { return(!o ? "mce_" : o) + (this.counter++); },
        ...
        processHTML: function(r) {
            ...
            if (q.keep_values) {
                if (/<script|noscript|style/i.test(r)) {
                    ...
                    r = r.replace(/<noscript([^>]+|)>([\s\S]*?)<\/noscript>/g, function(s, x, t) { return"<mce:noscript" + x + "><!--" + p.encode(t).replace(/--/g, "&#45;&#45;") + "--></mce:noscript>"; });
                }
                ...
                r = u(r);
                r = r.replace(/MCE_SCRIPT:([0-9]+)/g, function(t, s) { return v[s]; });
            }
            return r;
        },
        ...
        encode: function(o) { return("" + o).replace(n, function(p) { return c[p]; }); },
        ...
        replace: function(s, r, p) {
            ...
            return q.run(r, function(t) {
                if (p) {
                    k(m.grep(t.childNodes), function(o) { s.appendChild(o); });
                }
        ...
        rename: function(r, o) {
            ...
            if (r.nodeName != o.toUpperCase()) {
                p = q.create(o);
                k(q.getAttribs(r), function(s) { q.setAttrib(p, s.nodeName, q.getAttrib(r, s.nodeName)); });
                q.replace(p, r, 1);
            }
            return p || r;
        },
        ...
        getAttribs: function(q) {
            ...
            if (d) {
                ...
                if (q.nodeName === "OPTION" && this.getAttrib(q, "selected")) {
                    p.push({ specified: 1, nodeName: "selected" });
                }
                q.cloneNode(false).outerHTML.replace(/<\/?[\w:\-]+ ?|=[\"][^\"]+\"|=\'[^\']+\'|=[\w\-]+|>/gi, "").replace(/[\w:\-]+/gi, function(o) { p.push({ specified: 1, nodeName: o }); });
                return p;
            }
            return q.attributes;
        },
        ...
        nodeIndex: function(r, s) {
            var o = 0, q, p;
            if (r) {
                for (q = r.nodeType, r = r.previousSibling, lastNode = r; r; r = r.previousSibling) {
                    p = r.nodeType;
                    if (!s || p != 3 || (q != p && r.nodeValue.length)) {
                        o++;
                    }
                    q = p;
                }
        ...
        _isRes: function(o) { return/^(top|left|bottom|right|width|height)/i.test(o) || /;\s*(top|left|bottom|right|width|height)/i.test(o); }
    });
    m.DOM = new m.dom.DOMUtils(document, { process_html: 0 });
})(tinymce);
(function(a) {
    function b(c) {
...
(function() {
    function a(h) {
        var j = this, k = "\uFEFF", f, i, e = h.dom, d = true, g = false;
        ...
        function b() {
            var p = h.getRng(), l = e.createRng(), m, n, r, q;
        ...
        this.addRange = function(m) {
            var u, A, z = h.dom.doc, s = z.body, v, o, y, p, t, l, q, r, x, n;
            this.destroy();
            y = m.startContainer;
            p = m.startOffset;
            t = m.endContainer;
        ...
        this.destroy = function() { i = f = null; };
        if (h.dom.boxModel) {
            (function() {
                var r = e.doc, m = r.body, o, p;
    ...
    d.create("tinymce.dom.EventUtils", {
        ...
        add: function(m, p, l, j) {
            ...
            if (p instanceof Array) {
                k = [];
                f(p, function(o) { k.push(h.add(m, o, l, j)); });
                return k;
            }
        ...
        _wait: function(i) {
            ...
            if (h.attachEvent) {
                ...
                if (h.addEventListener) {
                    g._add(i, "DOMContentLoaded", function() { g._pageInit(i); });
                }
            }
            g._add(i, "load", function() { g._pageInit(i); });
        },
        _stoppers: { preventDefault: function() { this.returnValue = false; }, stopPropagation: function() { this.cancelBubble = true; } }
    });
...
(function(a) {
    a.dom.Element = function(f, d) {
        ...
        a.extend(b, {
            on: function(i, h, g) { return a.dom.Event.add(b.id, i, h, g); },
            getXY: function() { return{ x: parseInt(b.getStyle("left")), y: parseInt(b.getStyle("top")) }; },
            getSize: function() {
                var g = e.get(b.id);
                return{ w: parseInt(b.getStyle("width") || g.clientWidth), h: parseInt(b.getStyle("height") || g.clientHeight) };
            },
            moveTo: function(g, h) { b.setStyles({ left: g, top: h }); },
            moveBy: function(g, i) {
                var h = b.getXY();
                b.moveTo(h.x + g, h.y + i);
            },
            resizeTo: function(g, i) { b.setStyles({ width: g, height: i }); },
        ...
        getBookmark: function(q, r) {
            ...
            if (q == 2) {
                function k() {
                    ...
                    function y(B, F) {
                        var A = B[F ? "startContainer" : "endContainer"], E = B[F ? "startOffset" : "endOffset"], z = [], D, C = 0;
                        if (A.nodeType == 3) {
                            if (r) {
                                for (node = A.previousSibling; node && node.nodeType == 3; node = node.previousSibling) {
                                    E += node.nodeValue.length;
                                }
                            }
                            z.push(E);
                        } else {
                            ...
                            z.push(u.dom.nodeIndex(D[E], r) + C);
                        }
            ...
            if (g.duplicate || g.item) {
                ...
                if (!n) {
                    j.collapse(false);
                    j.insertNode(m.create("span", { _mce_type: "bookmark", id: i + "_end", style: s }, l));
                }
                g.collapse(true);
                g.insertNode(m.create("span", { _mce_type: "bookmark", id: i + "_start", style: s }, l));
            }
            u.moveToBookmark({ id: i, keep: 1 });
            return{ id: i };
        },
        moveToBookmark: function(l) {
            var n = this, k = n.dom, i, h, f, m;
            if (n.tridentSel) {
            ...
            if (l) {
                if (l.start) {
                    ...
                    if (l.id) {
                        ...
                        function j(u) {
                            var p = k.get(l.id + "_" + u), t, o, r, s, q = l.keep;
                            if (p) {
                                t = p.parentNode;
                                if (u == "start") {
                                    if (!q) {
                                ...
                                if (!q) {
                                    s = p.previousSibling;
                                    r = p.nextSibling;
                                    d(c.grep(p.childNodes), function(v) {
                                        if (v.nodeType == 3) {
    ...
    e.create("tinymce.dom.Serializer", {
        Serializer: function(j) {
            ...
            if (j.element_format == "html") {
                i.onPostProcess.add(function(k, l) { l.content = l.content.replace(/<([^>]+) \/>/g, "<$1>"); });
            }
        ...
        serialize: function(r, q) {
            ...
            r = r.cloneNode(true);
            if (d) {
                f(r.getElementsByTagName("option"), function(o, h) { k.dom.setAttrib(o, "selected", l[h]); });
            }
            j = r.ownerDocument.implementation;
            if (j.createHTMLDocument && (e.isOpera && opera.buildNumber() >= 1767)) {
                p = j.createHTMLDocument("");
                f(r.nodeName == "BODY" ? r.childNodes : [r], function(h) { p.body.appendChild(p.importNode(h, true)); });
                if (r.nodeName != "BODY") {
                    r = p.body.firstChild;
                } else {
                    r = p.body;
        ...
        _postProcess: function(n) {
            ...
            if (n.format == "html") {
                l = i._protect({ content: j, patterns: [{ pattern: /(<script[^>]*>)(.*?)(<\/script>)/g }, { pattern: /(<noscript[^>]*>)(.*?)(<\/noscript>)/g }, { pattern: /(<style[^>]*>)(.*?)(<\/style>)/g }, { pattern: /(<pre[^>]*>)(.*?)(<\/pre>)/g, encode: 1 }, { pattern: /(<!--\[CDATA\[)(.*?)(\]\]-->)/g }] });
                j = l.content;
                ...
                j = j.replace(/<noscript([^>]+|)>([\s\S]*?)<\/noscript>/g, function(h, p, o) { return"<noscript" + p + ">" + i.dom.decode(o.replace(/<!--|-->/g, "")) + "</noscript>"; });
            }
            n.content = j;
        },
        ...
        _unprotect: function(i, j) {
            i = i.replace(/\<!--mce:([0-9]+)--\>/g, function(k, h) { return j.items[parseInt(h)]; });
            j.items = [];
            return i;
        },
        _encode: function(m) {
            ...
            if (k.entity_encoding !== "raw") {
                ...
                if (k.entity_encoding.indexOf("numeric") != -1) {
                    m = m.replace(/[\u007E-\uFFFF]/g, function(h) { return"&#" + h.charCodeAt(0) + ";"; });
                }
            }
            return m;
        },
...
(function(a) {
    a.dom.ScriptLoader = function(h) {
        ...
        this.isDone = function(m) { return l[m] == i; };
        this.markDone = function(m) { l[m] = i; };
        ...
        this.loadQueue = function(n, m) { this.loadScripts(j, n, m); };
        this.loadScripts = function(m, q, p) {
            var o;

            function n(r) {
                a.each(f[r], function(s) { s.func.call(s.scope); });
                f[r] = e;
            }
...
tinymce.dom.TreeWalker = function(a, c) {
    ...
    this.next = function(e) { return(b = d(b, "firstChild", "nextSibling", e)); };
    this.prev = function(e) { return(b = d(b, "lastChild", "lastSibling", e)); };
};
(function() {
    var a = {};
    ...
    function b(f, e) {
        ...
        function c(g) { return g.replace(/[A-Z]+/g, function(h) { return c(f[h]); }); }
...
(function(c) {
    ...
    c.create("tinymce.ui.Control", {
        ...
        renderHTML: function() {},
        renderTo: function(d) { b.setHTML(d, this.renderHTML()); },
        postRender: function() {
            var e = this, d;
            if (a(e.disabled)) {
                d = e.disabled;
...
(function(c) {
    ...
    c.create("tinymce.ui.MenuButton:tinymce.ui.Button", {
        ...
        hideMenu: function(g) {
            var f = this;
            if (g && g.type == "mousedown" && b.getParent(g.target, function(h) { return h.id === f.id || h.id === f.id + "_open"; })) {
                return;
            }
    ...
    d.create("tinymce.ui.ColorSplitButton:tinymce.ui.SplitButton", {
        ...
        renderMenu: function() {
            ...
            e(b(l.colors, "array") ? l.colors : l.colors.split(","), function(i) {
                ...
                p = c.add(o, "td");
                p = c.add(p, "a", { href: "javascript:;", style: { backgroundColor: "#" + i }, _mce_color: "#" + i });
            });
...
(function(b) {
    ...
    b.create("tinymce.AddOnManager", {
        ...
        lookup: {},
        onAdd: new a(this),
        get: function(d) { return this.lookup[d]; },
...
(function(j) {
    ...
    i.add(window, "beforeunload", function(l) { j.onBeforeUnload.dispatch(j, l); });
    ...
    j.EditorManager = d(j, {
        ...
        init: function(q) {
            ...
            i.add(document, "init", function() {
                ...
                case"specific_textareas":
                    function t(y, x) { return x.constructor === RegExp ? x.test(y.className) : k.hasClass(y, x); }
        ...
        getInstanceById: function(l) { return this.get(l); },
        add: function(m) {
        ...
        triggerSave: function() { g(this.editors, function(l) { l.save(); }); },
        addI18n: function(n, q) {
            ...
            if (!j.is(n, "string")) {
                ...
                g(q, function(r, p) { m[n + "." + p] = r; });
            }
        },
        _setActive: function(l) { this.selectedInstance = this.activeEditor = l; }
    });
})(tinymce);
(function(m) {
    ...
    m.create("tinymce.Editor", {
        ...
        render: function(r) {
            ...
            if (!j.domLoaded) {
                j.add(document, "init", function() { u.render(); });
                return;
            }
            tinyMCE.settings = v;
            if (!u.getElement()) {
        ...
        init: function() {
            ...
            if (F.render_ui) {
                ...
                q = E.theme.renderUI({ targetNode: A, width: B, height: y, deltaWidth: F.delta_width, deltaHeight: F.delta_height });
                E.editorContainer = q.editorContainer;
            }
            if (document.domain && location.hostname != document.domain) {
                m.relaxedDomain = document.domain;
            }
            n.setStyles(q.sizeContainer || q.editorContainer, { width: B, height: y });
        ...
        setupIframe: function() {
            ...
            z.dom = new m.dom.DOMUtils(z.getDoc(), { keep_values: true, url_converter: z.convertURL, url_converter_scope: z, hex_colors: A.force_hex_style_colors, class_filter: A.class_filter, update_styles: 1, fix_ie_paragraphs: 1, valid_styles: A.valid_styles });
            z.schema = new m.dom.Schema();
            z.serializer = new m.dom.Serializer(f(A, { valid_elements: A.verify_html === false ? "*[*]" : A.valid_elements, dom: z.dom, schema: z.schema }));
            z.selection = new m.dom.Selection(z.dom, z.getWin(), z.serializer);
            z.formatter = new m.Formatter(this);
            z.formatter.register({ alignleft: [{ selector: "p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li", styles: { textAlign: "left" } }, { selector: "img,table", styles: { "float": "left" } }], aligncenter: [{ selector: "p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li", styles: { textAlign: "center" } }, { selector: "img", styles: { display: "block", marginLeft: "auto", marginRight: "auto" } }, { selector: "table", styles: { marginLeft: "auto", marginRight: "auto" } }], alignright: [{ selector: "p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li", styles: { textAlign: "right" } }, { selector: "img,table", styles: { "float": "right" } }], alignfull: [{ selector: "p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li", styles: { textAlign: "justify" } }], bold: [{ inline: "strong" }, { inline: "span", styles: { fontWeight: "bold" } }, { inline: "b" }], italic: [{ inline: "em" }, { inline: "span", styles: { fontStyle: "italic" } }, { inline: "i" }], underline: [{ inline: "span", styles: { textDecoration: "underline" }, exact: true }, { inline: "u" }], strikethrough: [{ inline: "span", styles: { textDecoration: "line-through" }, exact: true }, { inline: "u" }], forecolor: { inline: "span", styles: { color: "%value" } }, hilitecolor: { inline: "span", styles: { backgroundColor: "%value" } }, fontname: { inline: "span", styles: { fontFamily: "%value" } }, fontsize: { inline: "span", styles: { fontSize: "%value" } }, blockquote: { block: "blockquote", wrapper: 1 }, removeformat: [{ selector: "b,strong,em,i,font,u,strike", remove: "all", split: true, expand: false, block_expand: true, deep: true }, { selector: "span", attributes: ["style", "class"], remove: "empty", split: true, expand: false, deep: true }, { selector: "*", attributes: ["style", "class"], split: false, expand: false, deep: true }] });
            i("p h1 h2 h3 h4 h5 h6 div address pre div code dt dd samp".split(/\s/), function(s) { z.formatter.register(s, { block: s }); });
            ...
            z.undoManager.onUndo.add(function(t, s) { return z.onUndo.dispatch(z, s, t); });
            z.undoManager.onRedo.add(function(t, s) { return z.onRedo.dispatch(z, s, t); });
            z.forceBlocks = new m.ForceBlocks(z, { forced_root_block: A.forced_root_block });
            ...
            if (A.handle_node_change_callback) {
                z.onNodeChange.add(function(t, s, B) { z.execCallback("handle_node_change_callback", z.id, B, -1, -1, true, z.selection.isCollapsed()); });
            }
            if (A.save_callback) {
            ...
            if (A.onchange_callback) {
                z.onChange.add(function(t, s) { z.execCallback("onchange_callback", z, s); });
            }
            ...
            if (A.fix_nesting && b) {
                z.onBeforeSetContent.add(function(s, t) { t.content = z._fixNesting(t.content); });
            }
            if (A.preformatted) {
                z.onPostProcess.add(function(s, t) {
            ...
            if (A.cleanup_callback) {
                z.onBeforeSetContent.add(function(s, t) { t.content = z.execCallback("cleanup_callback", "insert_to_editor", t.content, t); });
            ...
            z.onSetContent.add(function() { z.addVisual(z.getBody()); });
            if (A.padd_empty_editor) {
                z.onPostProcess.add(function(s, t) { t.content = t.content.replace(/^(<p[^>]*>(&nbsp;|&#160;|\s|\u00a0|)<\/p>[\r\n]*|<br \/>[\r\n]*)$/, ""); });
            }
            if (a) {
                function p(s, t) {
            ...
            setTimeout(function() {
                ...
                if (A.content_css) {
                    m.each(g(A.content_css), function(s) { z.dom.loadCSS(z.documentBaseURI.toAbsolute(s)); });
                }
                if (A.auto_focus) {
                    setTimeout(function() {
        ...
        focus: function(q) {
            var s, p = this, r = p.settings.content_editable;
            if (!q) {
                if (!r) {
                    p.getWin().focus();
                }
        ...
        getLang: function(q, p) { return m.i18n[(this.settings.language || "en") + "." + q] || (d(p) ? p : "{#" + q + "}"); },
        ...
        nodeChanged: function(r) {
            var p = this, q = p.selection, u = q.getNode() || p.getBody();
            if (p.initialized) {
                r = r || {};
        ...
        addShortcut: function(r, u, p, s) {
            ...
            if (d(p, "string")) {
                v = p;
                p = function() { q.execCommand(v, false, null); };
            }
            if (d(p, "object")) {
                v = p;
                p = function() { q.execCommand(v[0], v[1], v[2]); };
            }
            i(g(r), function(t) {
        ...
        _addEvents: function() {
            var v = this, u, y = v.settings, x = { mouseup: "onMouseUp", mousedown: "onMouseDown", click: "onClick", keyup: "onKeyUp", keydown: "onKeyDown", keypress: "onKeyPress", submit: "onSubmit", reset: "onReset", contextmenu: "onContextMenu", dblclick: "onDblClick", paste: "onPaste" };
            ...
            i(x, function(t, s) {
                ...
                case"contextmenu":
                    ...
                    break;
                case"paste":
                    v.dom.bind(v.getBody(), s, function(A) { r(A); });
                    break;
                case"submit":
                case"reset":
            ...
            v.dom.bind(y.content_editable ? v.getBody() : (a ? v.getDoc() : v.getWin()), "focus", function(s) { v.focus(true); });
            if (m.isGecko) {
            ...
            v.onReset.add(function() { v.setContent(v.startContent, { format: "raw" }); });
            ...
            if (m.isIE) {
                v.dom.bind(v.getDoc(), "controlselect", function(A) {
                    ...
                    t = v.resizeInfo = { node: A, ev: ev, cb: s };
                });
                v.onKeyDown.add(function(s, t) {
                    switch (t.keyCode) {
                    case 8:
            ...
            if (m.isOpera) {
                v.onClick.add(function(s, t) { j.prevent(t); });
            }
...
(function(c) {
    ...
    c.EditorCommands = function(n) {
        ...
        function t(u, v) {
            v = v || "exec";
            d(u, function(y, x) { d(x.toLowerCase().split(","), function(z) { j[v][z] = y; }); });
        }
        ...
        t({
            ...
            "Bold,Italic,Underline,Strikethrough": function(u) { r(u); },
            "ForeColor,HiliteColor,FontName": function(x, v, u) { r(x, u); },
            ...
            RemoveFormat: function(u) { n.formatter.remove(u); },
            mceBlockQuote: function(u) { r("blockquote"); },
            FormatBlock: function(x, v, u) { return r(u); },
            mceCleanup: function() {
                i();
            ...
            mceSelectNode: function(x, v, u) { p.select(u); },
            mceInsertContent: function(x, v, u) { p.setContent(u); },
            mceInsertRawHTML: function(x, v, u) {
                p.setContent("tiny_mce_marker");
                n.setContent(n.getContent().replace(/tiny_mce_marker/g, u));
            },
            mceSetContent: function(x, v, u) { n.setContent(u); },
            ...
            mceToggleFormat: function(x, v, u) { n.formatter.toggle(u); },
            InsertHorizontalRule: function() { p.setContent("<hr />"); },
            mceToggleVisualAid: function() {
                n.hasVisual = !n.hasVisual;
                n.addVisual();
            },
            mceReplaceContent: function(x, v, u) { p.setContent(u.replace(/\{\$selection\}/g, p.getContent({ format: "text" }))); },
            mceInsertLink: function(y, x, v) {
                ...
                if (!u) {
                    ...
                    d(l.select("a[href=javascript:mctmp(0);]"), function(z) { l.setAttribs(z, v); });
                } else {
                    if (v.href) {
                        l.setAttribs(u, v);
                    } else {
        ...
        t({
            "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function(u) { return s("align" + u.substring(7)); },
            "Bold,Italic,Underline,Strikethrough": function(u) { return s(u); },
            mceBlockQuote: function() { return s("blockquote"); },
            Outdent: function() {
                var u;
                if (k.inline_styles) {
            ...
            "InsertUnorderedList,InsertOrderedList": function(u) { return l.getParent(p.getNode(), u == "insertunorderedlist" ? "UL" : "OL"); }
        }, "state");
        t({
        ...
        if (k.custom_undo_redo) {
            t({ Undo: function() { n.undoManager.undo(); }, Redo: function() { n.undoManager.redo(); } });
        }
    };
})(tinymce);
(function(b) {
    ...
    b.UndoManager = function(e) {
        ...
        function f() { return b.trim(e.getContent({ format: "raw", no_events: 1 })); }
        ...
        return c = {
            ...
            hasUndo: function() { return d > 0 || c.typing; },
            hasRedo: function() { return d < g.length - 1; }
        };
    };
})(tinymce);
(function(l) {
    ...
    l.create("tinymce.ForceBlocks", {
        ...
        setup: function() {
            ...
            m.onPreProcess.add(function(s, t) {
                j(r.select("p,h1,h2,h3,h4,h5,h6,div", t.node), function(u) {
                    if (f(u)) {
                        j(r.select("span,em,strong,b,i", t.node), function(v) {
                            if (!v.hasChildNodes()) {
            ...
            if (c) {
                if (p.element != "P") {
                    m.onKeyPress.add(function(s, t) { n.lastElm = o.getNode().nodeName; });
        ...
        find: function(u, p, q) {
            var o = this.editor, m = o.getDoc().createTreeWalker(u, 4, null, h), r = -1;
            while (u = m.nextNode()) {
                r++;
                if (p == 0 && u == q) {
                    return r;
                            ...
                            if (M == -2 && A) {
                                if (!c) {
                                    if (A.startContainer.nodeType == 1 && (C = A.startContainer.childNodes[A.startOffset]) && C.nodeType == 1) {
                                        ...
                                        if (v.dom.getParent(A.startContainer, function(n) { return n === L; })) {
                                            F = A.startOffset;
                                            m = A.endOffset;
        ...
        insertPara: function(R) {
            ...
            function A(r) { return S.createTreeWalker(r, NodeFilter.SHOW_TEXT, null, h).nextNode() || r; }
        ...
        backspaceDelete: function(s, A) {
            var C = this, q = C.editor, x = q.getBody(), p = q.dom, o, u = q.selection, m = u.getRng(), v = m.startContainer, o, y, z;
            ...
            window.setTimeout(function() { k._remove(x, "DOMNodeInserted", B); }, 1);
        }
    });
})(tinymce);
(function(c) {
    ...
    c.create("tinymce.ControlManager", {
        ControlManager: function(f, j) {
            ...
            h._cls = {};
            h.onPostRender.add(function() { d(h.controls, function(i) { i.postRender(); }); });
        },
        ...
        createListBox: function(m, i, l) {
            ...
            i.scope = i.scope || g;
            if (!i.onselect) {
                i.onselect = function(n) { g.execCommand(i.cmd, i.ui || false, n || i.value); };
            }
            ...
            if (c.isWebKit) {
                k.onPostRender.add(function(p, o) {
                    a.add(o, "mousedown", function() { g.bookmark = g.selection.getBookmark(1); });
        ...
        createButton: function(m, i, l) {
            ...
            if (!i.onclick && !i.menu_button) {
                i.onclick = function() { g.execCommand(i.cmd, i.ui || false, i.value); };
            }
        ...
        createSplitButton: function(m, i, l) {
            ...
            i.scope = i.scope || g;
            if (!i.onclick) {
                i.onclick = function(n) { g.execCommand(i.cmd, i.ui || false, n || i.value); };
            }
            if (!i.onselect) {
                i.onselect = function(n) { g.execCommand(i.cmd, i.ui || false, n || i.value); };
            }
        ...
        createColorSplitButton: function(f, n, h) {
            ...
            if (!n.onselect) {
                n.onselect = function(o) { j.execCommand(n.cmd, n.ui || false, o || n.value); };
            }
        ...
        destroy: function() {
            d(this.controls, function(f) { f.destroy(); });
            this.controls = null;
        }
    });
})(tinymce);
(function(d) {
    ...
    d.create("tinymce.WindowManager", {
        ...
        resizeBy: function(f, g, h) { h.resizeBy(f, g); },
...
(function(a) {
    function b() {
        ...
        function f(j, i, h, g) {
            ...
            a.each(i, function(k) { j[k.toLowerCase()] = { func: h, scope: g }; });
        }

        a.extend(this, {
            add: function(i, h, g) { f(d, i, h, g); },
            addQueryStateHandler: function(i, h, g) { f(c, i, h, g); },
            addQueryValueHandler: function(i, h, g) { f(e, i, h, g); },
...
(function(a) {
    a.Formatter = function(R) {
        var I = {}, K = a.each, c = R.dom, p = R.selection, s = a.dom.TreeWalker, G = new a.dom.RangeUtils(c), d = R.schema.isValid, C = c.isBlock, k = R.settings.forced_root_block, r = c.nodeIndex, B = "\uFEFF", e = /^(src|href|style)$/, O = false, y = true, o, L = { apply: [], remove: [] };

        function l(T, S) { return c.getParents(T, S, c.getRoot()); }

        function b(S) { return S.nodeType === 1 && (S.face === "mceinline" || S.style.fontFamily === "mceinline"); }

        function N(S) { return S ? I[S] : I; }

        function j(S, T) {
            if (S) {
                if (typeof(S) !== "string") {
                    K(S, function(V, U) { j(U, V); });
                } else {
                    T = T.length ? T : [T];
                    K(T, function(U) {
                        if (U.deep === o) {
                        ...
                        if (U.split === o) {
                            U.split = !U.selector || U.inline;
                        }
                        if (U.remove === o && U.selector && !U.inline) {
                            U.remove = "none";
                        }
                        if (U.selector && U.inline) {
                            U.mixed = true;
                            U.block_expand = true;
                        }
                        if (typeof(U.classes) === "string") {
                            U.classes = U.classes.split(/\s+/);
                        }
                    });
                    I[S] = T;
                }
        ...
        function P(U, aa, W) {
            var X = N(U), ab = X[0], Z, T, Y;

            function V(ae) {
                var ad = ae.startContainer, ah = ae.startOffset, ag, af;
                if (ad.nodeType == 1 || ad.nodeValue === "") {
                    ag = new s(ad.childNodes[ah]);
                    for (af = ag.current(); af; af = ag.next()) {
                        if (af.nodeType == 3 && !C(af.parentNode) && !f(af)) {
                            ae.setStart(af, 0);
                            break;
                        }
                    }
            ...
            function S(ae, ad) {
                ad = ad || ab;
                if (ae) {
                    K(ad.styles, function(ag, af) { c.setStyle(ae, af, q(ag, aa)); });
                    K(ad.attributes, function(ag, af) { c.setAttrib(ae, af, q(ag, aa)); });
                    K(ad.classes, function(af) {
                        af = q(af, aa);
                        if (!c.hasClass(ae, af)) {
                            c.addClass(ae, af);
                        }
            ...
            function ac(ae) {
                var ad = [], ag, af;
                ag = ab.inline || ab.block;
                af = c.create(ag);
                S(af);
                G.walk(ae, function(ah) {
                    var ai;

                    function aj(ak) {
                        var an = ak.nodeName.toLowerCase(), am = ak.parentNode.nodeName.toLowerCase(), al;
                        if (g(an, "br")) {
                            ai = 0;
                            if (ab.block) {
                                c.remove(ak);
                        ...
                        if (ab.wrapper && u(ak, U, aa)) {
                            ai = 0;
                            return;
                        }
                        if (ab.block && !ab.wrapper && D(an)) {
                            ak = c.rename(ak, ag);
                            S(ak);
                            ad.push(ak);
                            ai = 0;
                ...
                K(ad, function(aj) {
                    ...
                    function ai(al) {
                        var an, am;
                        K(al.childNodes, function(ao) {
                            if (ao.nodeType == 1 && !E(ao) && !b(ao)) {
                                an = ao;
                                return O;
                            }
                        });
                    ...
                    if (ab.inline || ab.wrapper) {
                        if (!ab.exact && ah === 1) {
                            aj = ai(aj);
                        }
                        K(X, function(al) { K(c.select(al.inline, aj), function(am) { Q(al, aa, am, al.exact ? am : null); }); });
                        c.getParent(aj.parentNode, function(al) {
                            if (u(al, U, aa)) {
                                c.remove(aj, 1);
                                aj = 0;
                                return y;
            ...
            if (ab) {
                if (W) {
                    ...
                    if (!p.isCollapsed() || !ab.inline) {
                        Z = p.getBookmark();
                        ac(n(p.getRng(y), X));
                        p.moveToBookmark(Z);
                        p.setRng(V(p.getRng(y)));
                        R.nodeChanged();
                    } else {
                        M("apply", U, aa);
                    }
        ...
        function x(U, ac, W) {
            var X = N(U), ae = X[0], ab, aa, T;

            function V(aj) {
                var ai, ah, ag;
                ai = a.grep(aj.childNodes);
                for (ah = 0, ag = X.length; ah < ag; ah++) {
                    if (Q(X[ah], ac, aj, aj)) {
                        break;
                    }
                }
            ...
            function Y(ag) {
                var ah;
                K(l(ag.parentNode).reverse(), function(ai) {
                    var aj;
                    if (!ah && ai.id != "_start" && ai.id != "_end") {
                        aj = u(ai, U, ac);
                        if (aj && aj.split !== false) {
                            ah = ai;
                        }
                    }
                });
            ...
            function S(aj, ag, al, ao) {
                var ap, an, am, ai, ak, ah;
                if (aj) {
                    ah = aj.parentNode;
                    for (ap = ag.parentNode; ap && ap != ah; ap = ap.parentNode) {
                        an = ap.cloneNode(O);
                        for (ak = 0; ak < X.length; ak++) {
                            if (Q(X[ak], ac, an, an)) {
                                an = 0;
                                break;
                            }
            ...
            function ad(ag) { return S(Y(ag), ag, ag, true); }

            function Z(ai) {
                var ah = c.get(ai ? "_start" : "_end"), ag = ah[ai ? "firstChild" : "lastChild"];
                c.remove(ah, 1);
                return ag;
            }
            ...
            function af(ag) {
                ...
                if (ae.split) {
                    ...
                    ai = F(ag);
                    if (ah != ai) {
                        ah = J(ah, "span", { id: "_start", _mce_type: "bookmark" });
                        ai = J(ai, "span", { id: "_end", _mce_type: "bookmark" });
                        ad(ah);
                        ad(ai);
                        ah = Z(y);
                        ai = Z();
                    ...
                    ag.startContainer = ah.parentNode;
                    ag.startOffset = r(ah);
                    ag.endContainer = ai.parentNode;
                    ag.endOffset = r(ai) + 1;
                }
                G.walk(ag, function(aj) { K(aj, function(ak) { V(ak); }); });
            }
        ...
        function u(V, S, X) {
            ...
            function Z(ad, af, ag) {
                var ac, ae, aa = af[ag], ab;
                if (aa) {
                    if (aa.length === o) {
                        for (ac in aa) {
                            if (aa.hasOwnProperty(ac)) {
                                if (ag === "attributes") {
                                    ae = c.getAttrib(ad, ac);
                                } else {
                                    ae = H(ad, ac);
                                }
                                if (!g(ae, q(aa[ac], X))) {
                        ...
                        for (ab = 0; ab < aa.length; ab++) {
                            if (ag === "attributes" ? c.getAttrib(ad, aa[ab]) : H(ad, aa[ab])) {
                                return af;
                            }
                        }
                    }
            ...
            if (Y && V) {
                for (U = 0; U < Y.length; U++) {
                    W = Y[U];
                    if (h(V, W) && Z(V, W, "attributes") && Z(V, W, "styles")) {
                        if (T = W.classes) {
        ...
        function i(U, X, W) {
            ...
            function S(Y) {
                Y = c.getParent(Y, function(Z) { return !!u(Z, U, X); });
                return u(Y, U, X);
            }
            ...
            if (p.isCollapsed()) {
                for (V = L.apply.length - 1; V >= 0; V--) {
                    if (L.apply[V].name == U) {
                        return true;
                    }
                }
                for (V = L.remove.length - 1; V >= 0; V--) {
                    if (L.remove[V].name == U) {
                        return false;
                    }
                }
                return S(p.getNode());
        ...
        a.extend(this, { get: N, register: j, apply: P, remove: x, toggle: A, match: i, matchNode: u, canApply: v });
        ...
        function H(T, S) {
            var U = c.getStyle(T, S);
            if (S == "color" || S == "backgroundColor") {
                U = c.toHex(U);
            }
            if (S == "fontWeight" && U == 700) {
                U = "bold";
            }
            return"" + U;
        }
        ...
        function q(S, T) {
            if (typeof(S) != "string") {
                ...
                if (T) {
                    S = S.replace(/%(\w+)/g, function(V, U) { return T[U] || V; });
                }
            }
            return S;
        }

        function f(S) { return S && S.nodeType === 3 && /^\s*$/.test(S.nodeValue); }
        ...
        function n(S, aa, V) {
            var U = S.startContainer, X = S.startOffset, ad = S.endContainer, Y = S.endOffset, ac, Z;

            function ab(ag, ah, ae, af) {
                var ai, aj;
                af = af || c.getRoot();
                for (;;) {
                    ai = ag.parentNode;
                    if (ai == af || (!aa[0].block_expand && C(ai))) {
                        return ag;
                    }
                    for (ac = ai[ah]; ac && ac != ag; ac = ac[ae]) {
                        if (ac.nodeType == 1 && !E(ac)) {
                            return ag;
                        }
                        if (ac.nodeType == 3 && !f(ac)) {
                            return ag;
                        }
                    }
                    ag = ag.parentNode;
            ...
            if (U.nodeType == 1 && U.hasChildNodes()) {
                Z = U.childNodes.length - 1;
                U = U.childNodes[X > Z ? Z : X];
                if (U.nodeType == 3) {
                    X = 0;
                }
            }
            if (ad.nodeType == 1 && ad.hasChildNodes()) {
                Z = ad.childNodes.length - 1;
                ad = ad.childNodes[Y > Z ? Z : Y - 1];
                if (ad.nodeType == 3) {
                    Y = ad.nodeValue.length;
                }
            }
            if (E(U.parentNode)) {
                U = U.parentNode;
            ...
            if (E(ad)) {
                ad = ad.previousSibling || ad;
            }
            if (aa[0].inline || aa[0].block_expand) {
                U = ab(U, "firstChild", "nextSibling");
                ad = ab(ad, "lastChild", "previousSibling");
            }
            if (aa[0].selector && aa[0].expand !== O && !aa[0].inline) {
                function W(af, ae) {
                    var ag, ah, ai;
                    if (af.nodeType == 3 && af.nodeValue.length == 0 && af[ae]) {
                        af = af[ae];
                    }
                    ag = l(af);
                    for (ah = 0; ah < ag.length; ah++) {
                        for (ai = 0; ai < aa.length; ai++) {
                            if (c.is(ag[ah], aa[ai].selector)) {
                                return ag[ah];
                            }
                        }
                    }
                ...
                U = W(U, "previousSibling");
                ad = W(ad, "nextSibling");
            }
            if (aa[0].block || aa[0].selector) {
                function T(af, ae, ah) {
                    var ag;
                    if (!aa[0].wrapper) {
                        ag = c.getParent(af, aa[0].block);
                    }
                    if (!ag) {
                        ag = c.getParent(af.nodeType == 3 ? af.parentNode : af, C);
                    }
                    if (ag && aa[0].wrapper) {
                        ag = l(ag, "ul,ol").reverse()[0] || ag;
                    }
                    if (!ag) {
                        ag = af;
                        while (ag[ae] && !C(ag[ae])) {
            ...
            return{ startContainer: U, startOffset: X, endContainer: ad, endOffset: Y };
        }
        ...
        function Q(Y, X, V, S) {
            ...
            if (Y.remove != "all") {
                ...
                if (W && c.getAttrib(V, "style") == "") {
                    V.removeAttribute("style");
                    V.removeAttribute("_mce_style");
                }
                K(Y.attributes, function(ab, Z) {
                    var aa;
                    ab = q(ab, X);
                    if (typeof(Z) === "number") {
                        Z = ab;
                    ...
                    if (!S || g(c.getAttrib(S, Z), ab)) {
                        if (Z == "class") {
                            ab = c.getAttrib(V, Z);
                            if (ab) {
                                aa = "";
                                K(ab.split(/\s+/), function(ac) {
                                    if (/mce\w+/.test(ac)) {
                                        aa += (aa ? " " : "") + ac;
                                    }
                                });
                        ...
                        if (e.test(Z)) {
                            V.removeAttribute("_mce_" + Z);
                        }
                        V.removeAttribute(Z);
                    }
                });
                K(Y.classes, function(Z) {
                    Z = q(Z, X);
                    if (!S || c.hasClass(S, Z)) {
                        c.removeClass(V, Z);
                    }
        ...
        function m(U, V) {
            var S = U.parentNode, T;
            if (V.block) {
                if (!k) {
                    function W(Y, X, Z) {
                        Y = z(Y, X, Z);
                        return !Y || (Y.nodeName == "BR" || C(Y));
                    }

                    if (C(U) && !C(S)) {
                        if (!W(U, O) && !W(U.firstChild, y, 1)) {
                            U.insertBefore(c.create("br"), U.firstChild);
                        }
                        if (!W(U, y) && !W(U.lastChild, O, 1)) {
                            U.appendChild(c.create("br"));
                        }
                    }
                } else {
                    if (S == c.getRoot()) {
                        if (!V.list_block || !g(U, V.list_block)) {
                            K(a.grep(U.childNodes), function(X) {
                                if (d(k, X.nodeName.toLowerCase())) {
                                    if (!T) {
                                        T = J(X, k);
                                    } else {
                                        T.appendChild(X);
            ...
            if (V.selector && V.inline && !g(V.inline, U)) {
                return;
            }
            c.remove(U, 1);
        }
        ...
        function E(S) { return S && S.nodeType == 1 && S.getAttribute("_mce_type") == "bookmark"; }

        function t(W, V) {
            var S, U, T;

            function Y(ab, aa) {
                if (ab.nodeName != aa.nodeName) {
                    return O;
                }

                function Z(ad) {
                    var ae = {};
                    K(c.getAttribs(ad), function(af) {
                        var ag = af.nodeName.toLowerCase();
                        if (ag.indexOf("_") !== 0 && ag !== "style") {
                            ae[ag] = c.getAttrib(ad, ag);
                        }
                    });
                    return ae;
                }
                ...
                if (!ac(c.parseStyle(c.getAttrib(ab, "style")), c.parseStyle(c.getAttrib(aa, "style")))) {
                    return O;
                }
                return y;
            }
            ...
            if (W && V) {
                ...
                W = X(W, "previousSibling");
                V = X(V, "nextSibling");
                if (Y(W, V)) {
                    for (U = W.nextSibling; U && U != V;) {
                        T = U;
                        U = U.nextSibling;
                        W.appendChild(T);
                    }
                    c.remove(V);
                    K(a.grep(V.childNodes), function(Z) { W.appendChild(Z); });
                    return W;
                }
            }
            return V;
        ...
        function D(S) { return/^(h[1-6]|p|div|pre|address)$/.test(S); }

        function F(T, W) {
            var S, V, U;
            S = T[W ? "startContainer" : "endContainer"];
            V = T[W ? "startOffset" : "endOffset"];
            if (S.nodeType == 1) {
                U = S.childNodes.length - 1;
                if (!W && V) {
                    V--;
                }
                S = S.childNodes[V > U ? U : V];
            }
            return S;
        }

        function M(X, T, W) {
            var U, S = L[X], Y = L[X == "apply" ? "remove" : "apply"];

            function Z() { return L.apply.length || L.remove.length; }
            ...
            function aa(ab) {
                K(L.apply.reverse(), function(ac) { P(ac.name, ac.vars, ab); });
                K(L.remove.reverse(), function(ac) { x(ac.name, ac.vars, ab); });
                c.remove(ab, 1);
                V();
            }
            ...
            if (Z()) {
                R.getDoc().execCommand("FontName", false, "mceinline");
                K(c.select("font,span"), function(ac) {
                    var ab;
                    if (b(ac)) {
                        ab = p.getBookmark();
                        aa(ac);
                ...
                if (!L.isListening && Z()) {
                    L.isListening = true;
                    K("onKeyDown,onKeyUp,onKeyPress,onMouseUp".split(","), function(ab) {
                        R[ab].addToTop(function(ac, ad) {
                            if (Z()) {
                                K(c.select("font,span"), function(ag) {
                                    var af, ah, ae;
                                    if (b(ag)) {
                                        ah = ag.firstChild;
                                        aa(ag);
                                        ae = c.createRng();
                                        ae.setStart(ah, ah.nodeValue.length);
                                        ae.setEnd(ah, ah.nodeValue.length);
                                        p.setRng(ae);
                                        ac.nodeChanged();
                                    }
                                });
                                if (ad.type == "keyup" || ad.type == "mouseup") {
                                    V();
                                }
                            }
                        });
...
tinymce.onAddEditor.add(function(e, a) {
    ...
    if (c.inline_styles) {
        ...
        function b(j, i) { g.replace(g.create("span", { style: i }), j, 1); }

        d = { font: function(j, i) { b(i, { backgroundColor: i.style.backgroundColor, color: i.color, fontFamily: i.face, fontSize: h[parseInt(i.size) - 1] }); }, u: function(j, i) { b(i, { textDecoration: "underline" }); }, strike: function(j, i) { b(i, { textDecoration: "line-through" }); } };

        function f(i, j) {
            g = i.dom;
            if (c.convert_fonts_to_spans) {
                e.each(g.select("font,u,strike", j.node), function(k) { d[k.nodeName.toLowerCase()](a.dom, k); });
            }
        }

        a.onPreProcess.add(f);
        a.onInit.add(function() { a.selection.onSetContent.add(f); });
    }
});