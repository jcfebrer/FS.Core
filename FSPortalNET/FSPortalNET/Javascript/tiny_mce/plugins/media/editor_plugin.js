(function() {
    ...
    tinymce.create("tinymce.plugins.MediaPlugin", {
        ...
        _buildObj: function(g, h) {
            ...
            if (b) {
                d = f.create("span", { id: e.id, _mce_name: "object", type: "application/x-shockwave-flash", data: e.src, style: f.getAttrib(h, "style"), width: g.width, height: g.height });
            } else {
                d = f.create("span", { id: e.id, _mce_name: "object", classid: "clsid:" + g.classid, style: f.getAttrib(h, "style"), codebase: g.codebase, width: g.width, height: g.height });
            }
            a(e, function(j, i) {
                if (!/^(width|height|codebase|classid|id|_cx|_cy)$/.test(i)) {
                    ...
                    if (j) {
                        f.add(d, "span", { _mce_name: "param", name: i, _mce_value: j });
                    }
                }
            });
            if (!b) {
                f.add(d, "span", tinymce.extend({ _mce_name: "embed", type: g.type, style: f.getAttrib(h, "style") }, e));
            }
            return d;
        },
            ...
            a(f.select("span", e), function(g) {
                if (f.getAttrib(g, "class") == "mceItemObject") {
                    ...
                    case"clsid:d27cdb6e-ae6d-11cf-96b8-444553540000":
                        f.replace(d._createImg("mceItemFlash", g), g);
                        break;
                    case"clsid:166b1bca-3f9c-11cf-8075-444553540000":
                        f.replace(d._createImg("mceItemShockWave", g), g);
                        break;
                    case"clsid:6bf52a52-394a-11d3-b153-00c04f79faa6":
                    case"clsid:22d6f312-b0f6-11d0-94ab-0080c74c7e95":
                    case"clsid:05589fa1-c356-11ce-bf01-00aa0055595a":
                        f.replace(d._createImg("mceItemWindowsMedia", g), g);
                        break;
                    case"clsid:02bf25d5-8c17-4b23-bc80-d3488abddc6b":
                        f.replace(d._createImg("mceItemQuickTime", g), g);
                        break;
                    case"clsid:cfcdaa03-8be4-11cf-b84b-0020afbbccfa":
                        f.replace(d._createImg("mceItemRealMedia", g), g);
                        break;
                    default:
                        f.replace(d._createImg("mceItemFlash", g), g);
                    }
