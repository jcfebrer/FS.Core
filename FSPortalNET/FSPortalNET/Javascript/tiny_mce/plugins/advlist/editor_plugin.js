(function() {
    ...
    tinymce.create("tinymce.plugins.AdvListPlugin", {
        init: function(b, c) {
            ...
            function e(g) {
                var f = [];
                a(g.split(/,/), function(h) { f.push({ title: "advlist." + (h == "default" ? "def" : h.replace(/-/g, "_")), styles: { listStyleType: h == "default" ? "" : h } }); });
                return f;
            }
        ...
        createControl: function(d, b) {
            ...
            if (d == "numlist" || d == "bullist") {
                ...
                e = b.createSplitButton(d, { title: "advanced." + d + "_desc", "class": "mce_" + d, onclick: function() { g(); } });
                e.onRenderMenu.add(function(i, j) {
                    ...
                    j.add({ id: f.editor.dom.uniqueId(), title: "advlist.types", "class": "mceMenuItemTitle" }).setDisabled(1);
                    a(f[d], function(k) {
