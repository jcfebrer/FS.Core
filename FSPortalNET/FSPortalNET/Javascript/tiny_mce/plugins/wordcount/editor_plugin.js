    ...
    tinymce.create("tinymce.plugins.WordCount", {
        ...
        init: function(a, b) {
            ...
            a.onInit.add(function(e) {
                e.selection.onSetContent.add(function() { c._count(e); });
                c._count(e);
            });
            a.onSetContent.add(function(e) { c._count(e); });
        ...
        _count: function(b) {
            ...
            setTimeout(function() {
                ...
                if (d) {
                    ...
                    d.replace(c.countre, function() { a++; });
                }
                tinymce.DOM.setHTML(c.id, a.toString());
                setTimeout(function() { c.block = 0; }, 2000);
            }, 1);
        },
