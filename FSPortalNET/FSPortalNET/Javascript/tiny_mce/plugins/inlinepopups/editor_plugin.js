(function() {
    ...
    tinymce.create("tinymce.InlineWindowManager:tinymce.WindowManager", {
        ...
        open: function(r, j) {
            ...
            v.iframeElement.on("focus", function() { y.focus(i); });
