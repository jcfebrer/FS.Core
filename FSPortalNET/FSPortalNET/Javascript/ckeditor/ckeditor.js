...
(function() {
    if (!window.CKEDITOR)
        window.CKEDITOR = (function() {
            var a = {
                    timestamp: 'A1QD', version: '3.2', revision: '5205', _: {}, status: 'unloaded',
                    basePath: (function() {
    ...
    if (!a.env)
        a.env = (function() {
            var b = navigator.userAgent.toLowerCase(), c = window.opera, d = { ie: /*@cc_on!@*/false, opera: !!c && c.version, webkit: b.indexOf(' applewebkit/') > -1, air: b.indexOf(' adobeair/') > -1, mac: b.indexOf('macintosh') > -1, quirks: document.compatMode == 'BackCompat', isCustomDomain: function() { return this.ie && document.domain != window.location.hostname; } };
        ...
        a.tools = {
            ...
            htmlEncode: function(f) {
                var g = function(k) {
                    ...
                    i = g('>') == '>' ? function(k) { return h(k).replace(/>/g, '&gt;'); } : h,
                    j = g('  ') == '&nbsp; ' ? function(k) { return i(k).replace(/&nbsp;/g, ' '); } : i;
                this.htmlEncode = j;
            ...
            cssLength: (function() {
                var f = /^\d+(?:\.\d+)?$/;
                return function(g) { return g + (f.test(g) ? 'px' : ''); };
            })(),
    ...
    (function(g) {
        ...
        g.getUniqueId = function() { return this.$._cke_expando || (this.$._cke_expando = e.getNextNumber()); };
    ...
    e.extend(d.node.prototype, {
        ...
        getDocument: function() {
            ...
            return(this.getDocument = function() { return h; })();
        },
        getIndex: function() {
    ...
    h.clearAllMarkers = function(i) { for (var j in i)h.clearMarkers(i, i[j], true); };
    ...
    e.extend(h.prototype, {
        ...
        getStyle: function(i) { return this.$.style[e.cssStyleToDomStyle(i)]; },
        is: function() {
            var i = this.getName();
        ...
        unselectable: b.gecko ? function() { this.$.style.MozUserSelect = 'none'; } : b.webkit ? function() { this.$.style.KhtmlUserSelect = 'none'; } : function() {
            if (c || b.opera) {
                var i = this.$, j, k = 0;
                i.unselectable = 'on';
                while (j = i.all[k++])
                    ...
                    x = function(z) {
                        ...
                        if (m)
                            if (c)
                                ...
                                B.$.onload = function() { setTimeout(function() { w(z, true); }, 0); };
                                B.$.onerror = function() { w(z, false); };
                            }
    ...
    (function() {
        ...
        a.imageCacher = {
            load: function(m, n) {
                var o = m.length, p = function() { if (--o === 0)n(); };
    ...
    a.skins = (function() {
        var k = {},
            ...
            n = function(o, p, q, r) {
                ...
                var t = function(D) { for (var E = 0; E < D.length; E++)D[E] = a.getUrl(m[p] + D[E]); };
                ...
                if (w)r && r();
                    ...
                    var y = !q.css || !q.css.length, z = !q.js || !q.js.length,
                        A = function() {
                            if (y && z) {
                                q._isLoaded = 1;
        ...
        return{
            ...
            load: function(o, p, q) {
                ...
                if (k[r])n(o, r, p, q);
                    ...
                    m[r] = s;
                    a.scriptLoader.load(a.getUrl(s + 'skin.js'), function() { n(o, r, p, q); });
                }
            }
        };
    })();
    ...
    (function() {
        ...
        a.htmlParser.fragment.fromHtml = function(p, q) {
            ...
            function A() { while (v.length)w.add(v.shift()); };
            ...
            function B(E, F, G) {
                ...
                if (E._.isBlockLike && E.name != 'pre') {
                    ...
                    if (L && L.type == 3)
                        if (!(M = e.rtrim(L.value)))E.children.length = K - 1;
                        else L.value = M;
                }
                F.add(E);
                if (E.returnPoint) {
            ...
            r.onCDATA = function(E) { w.add(new a.htmlParser.cdata(E)); };
            r.onComment = function(E) { w.add(new a.htmlParser.comment(E)); };
            r.parse(p);
            A();
            while (w.type) {
                var C = w.parent, D = w;
        ...
        a.htmlParser.fragment.prototype = {
            ...
            writeChildrenHtml: function(p, q) { for (var r = 0; r < this.children.length; r++)this.children[r].writeHtml(p, q); }
        };
    })();
    ...
    (function() {
        var l = { address: 1, blockquote: 1, dl: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, li: 1, dt: 1, de: 1 }, m = { body: 1, div: 1, table: 1, tbody: 1, tr: 1, td: 1, th: 1, caption: 1, form: 1 },
            n = function(o) {
                var p = o.getChildren();
    ...
    e.extend(d.text.prototype, {
        type: 3, getLength: function() { return this.$.nodeValue.length; }, getText: function() { return this.$.nodeValue; },
        split: function(l) {
            var q = this;
            if (c && l == q.getLength()) {
    ...
    (function() {
        function l(t, u) {
            ...
            if (!t && !this._.guardLTR) {
                ...
                this._.guardLTR = function(G, H) { return(!H || !B.equals(G)) && (!C || !G.equals(C)) && (G.type != 1 || !H || G.getName() != 'body'); };
            }
            if (t && !this._.guardRTL) {
                var D = w.startContainer, E = w.startOffset > 0 && D.getChild(w.startOffset - 1);
                this._.guardRTL = function(G, H) { return(!H || !D.equals(G)) && (!E || !G.equals(E)) && (G.type != 1 || !H || G.getName() != 'body'); };
            }
        ...
        d.walker.blockBoundary = function(t) { return function(u, v) { return!(u.type == 1 && u.isBlockBoundary(t)); }; };
        ...
        d.walker.bookmarkContents = function(t) {}, d.walker.bookmark = function(t, u) {
            function v(w) { return w && w.getName && w.getName() == 'span' && w.hasAttribute('_fck_bookmark'); };
        ...
        var p = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, q = d.walker.whitespaces(true), r = d.walker.bookmark(false, true), s = function(t) { return r(t) && q(t); };
    ...
    (function() {
        var l = function(t) { t.collapsed = t.startContainer && t.endContainer && t.startContainer.equals(t.endContainer) && t.startOffset == t.endOffset; },
            m = function(t, u, v) {
                t.optimizeBookmark();
        ...
        function p(t) { return t.type != 3 && t.getName() in f.$removeEmpty || !e.trim(t.getText()) || t.getParent().hasAttribute('_fck_bookmark'); };
        ...
        d.range.prototype = {
                    ...
                    while (y || z) {
                        ...
                        while (z) {
                            ...
                            if (z.type == 3) {
                                ...
                                if (/[^\s\ufeff]/.test(D))z = null;
                                C = /[\s\ufeff]$/.test(D);
                            } else if (z.$.offsetWidth > 0 && !z.getAttribute('_fck_bookmark'))
                                if (B && f.$removeEmpty[z.getName()]) {
                                    D = z.getText();
                                    if (!/[^\s\ufeff]/.test(D))z = null;
                                    else {
            ...
            getEnclosedNode: function() {
                var t = this.clone(), u = new d.walker(t), v = d.walker.bookmark(true), w = d.walker.whitespaces(true), x = function(z) { return w(z) && v(z); };
                t.evaluator = x;
                var y = u.next();
                u.reset();
    ...
    j.add('basicstyles', {
        ...
        init: function(l) {
            var m = function(p, q, r, s) {
                    var t = new a.style(s);
                    l.attachStyleStateChange(t, function(u) { l.getCommand(r).setState(u); });
    ...
    j.add('button', { beforeInit: function(l) { l.ui.addHandler(1, k.button.handler); } });
    a.UI_BUTTON = 1;
    k.button = function(l) {
        e.extend(this, l, { title: l.label, className: l.className || l.command && 'cke_button_' + l.command || '', click: l.click || (function(m) { m.execCommand(l.command); }) });
        this._ = {};
    };
    k.button.handler = { create: function(l) { return new k.button(l); } };
    k.button.prototype = {
        canGroup: true,
        render: function(l, m) {
            ...
            this._.editor = l;
            var p = {
                    id: o, button: this, editor: l,
                    focus: function() {
                        var v = a.document.getById(o);
                        v.focus();
                    },
                    execute: function() { this.button.click(l); }
                },
                q = e.addFunction(p.execute, p),
                r = k.button._.instances.push(p) - 1,
                s = '',
                t = this.command;
            if (this.modes)l.on('mode', function() { this.setState(this.modes[l.mode] ? 2 : 0); }, this);
            else if (t) {
                t = l.getCommand(t);
                if (t) {
                    t.on('state', function() { this.setState(t.state); }, this);
    ...
    k.prototype.addButton = function(l, m) { this.add(l, 1, m); };
    (function() {
        var l = function(r, s) {
                var t = r.document, u = t.getBody(), v = false, w = function() { v = true; };
                u.on(s, w);
                t.$.execCommand(s);
                u.removeListener(s, w);
                return v;
            },
            m = c ? function(r, s) { return l(r, s); } : function(r, s) {
                try {
        ...
        var o = {
                ...
                exec: c ? function(r) {
                    ...
                    try {
                        ...
                        setTimeout(function() { r.fire('pasteDialog'); }, 0);
                        return false;
                    }
                }
            },
            p = function(r) {
                ...
                case 2000 + 46:
                    ...
                    setTimeout(function() { t.fire('saveSnapshot'); }, 0);
                }
            };
        ...
        j.add('clipboard', {
            ...
            init: function(r) {
                ...
                r.on('pasteDialog', function(w) { setTimeout(function() { r.openDialog('paste'); }, 0); });
                ...
                if (r.contextMenu) {
                    ...
                    r.contextMenu.addListener(function() { return{ cut: v('Cut'), copy: v('Cut'), paste: b.webkit ? 2 : v('Paste') }; });
                }
            }
        });
    })();
    j.add('colorbutton', {
        ...
        init: function(l) {
            ...
            function p(r, s, t) {
                l.ui.add(r, 4, {
                    label: t, title: t, className: 'cke_button_' + r.toLowerCase(), modes: { wysiwyg: 1 }, panel: { css: l.skin.editor.css, attributes: { role: 'listbox', 'aria-label': n.panelTitle } },
    ...
    i.colorButton_foreStyle = { element: 'span', styles: { color: '#(color)' }, overrides: [{ element: 'font', attributes: { color: null } }], childRule: function(l) { return l.getName() != 'a'; } };
    ...
    j.add('contextmenu', {
        ...
        beforeInit: function(l) {
            ...
            l.addCommand('contextMenu', { exec: function() { l.contextMenu.show(l.document.getBody()); } });
        }
    });
        ...
        proto: {
            addTarget: function(l, m) {
                ...
                l.on('contextmenu', function(r) {
                    ...
                    e.setTimeout(function() { this.show(u, null, v, w); }, 0, this);
                }, this);
                if (b.webkit) {
                    var o, p = function(r) { o = r.data.$.ctrlKey || r.data.$.metaKey; }, q = function() { o = 0; };
                    l.on('keydown', p);
                    l.on('keyup', q);
                    l.on('contextmenu', q);
                }
            },
            addListener: function(l) { this._.listeners.push(l); },
        ...
        j.add('div', {
            ...
            init: function(l) {
                ...
                if (l.addMenuItems) {
                    ...
                    if (l.contextMenu)
                        l.contextMenu.addListener(function(n, o) {
                            if (!n)return null;
    ...
    (function() {
        ...
        j.add('elementspath', {
            ...
            init: function(n) {
                ...
                n.on('contentDomUnload', function() { q().setHtml(m); });
    ...
    (function() {
        ...
        j.enterkey = {
            enterBlock: function(s, t, u, v) {
                ...
                if (!B && !C) {
                    ...
                    var F = y.elementPath;
                    if (F)
                        for (var G = 0, H = F.elements.length; G < H; G++) {
                            var I = F.elements[G];
        ...
        function p(s) { return q(s, s.config.shiftEnterMode, true); };
        ...
        j.add('entities', {
            afterInit: function(p) {
                ...
                if (s) {
                    ...
                    function w(x) { return u[x] || '&#' + x.charCodeAt(0) + ';'; };

                    s.addRules({ text: function(x) { return x.replace(v, w); } });
                }
            }
        });
    })();
    ...
    (function() {
        ...
        j.add('flash', {
            init: function(q) {
                ...
                if (q.contextMenu)q.contextMenu.addListener(function(r, s) { if (r && r.is('img') && r.getAttribute('_cke_real_element_type') == 'flash')return{ flash: 2 }; });
            },
    ...
    (function() {
        function l(m, n, o, p, q, r, s) {
            ...
            m.ui.addRichCombo(n, {
                label: p.label, title: p.panelTitle, className: 'cke_' + (o == 'size' ? 'fontSize' : 'font'), panel: { css: m.skin.editor.css.concat(t.contentsCss), multiSelect: false, attributes: { 'aria-label': p.panelTitle } },
                init: function() {
    ...
    j.add('format', {
        ...
        init: function(l) {
            ...
            l.ui.addRichCombo('Format', {
                label: n.label, title: n.panelTitle, className: 'cke_format', panel: { css: l.skin.editor.css.concat(m.contentsCss), multiSelect: false, attributes: { 'aria-label': n.panelTitle } },
                init: function() {
                ...
                onClick: function(s) {
                    ...
                    setTimeout(function() { l.fire('saveSnapshot'); }, 0);
                },
                onRender: function() {
    ...
    j.add('forms', {
        init: function(l) {
            ...
            if (l.contextMenu) {
                l.contextMenu.addListener(function(p) { if (p && p.hasAscendant('form', true))return{ form: 2 }; });
    ...
    if (c)
        h.prototype.hasAttribute = function(l) {
            var o = this;
    ...
    (function() {
        var l = { canUndo: false, exec: function(n) { n.insertElement(n.document.createElement('hr')); } }, m = 'horizontalrule';
        j.add(m, {
            init: function(n) {
                n.addCommand(m, l);
    ...
    (function() {
        ...
        function q(O) {
            o(O, true);
            if (p(O))
                if (c)O.add(new a.htmlParser.text('\xa0'));
        ...
        var x = {
                ...
                elements: {
                    ...
                    title: function(O) { O.children[0].value = O.attributes._cke_title; }
                },
                attributes: { 'class': function(O, P) { return e.ltrim(O.replace(/(?:^|\s+)cke_[^\s]*/g, '')) || false; } },
                comment: function(O) {
        ...
        if (c)x.attributes.style = function(O, P) { return O.toLowerCase(); };
        ...
        function F(O) { return O.replace(z, '$& _cke_saved_$1'); };

        function G(O) { return O.replace(A, function(P) { return '<cke:encoded>' + encodeURIComponent(P) + '</cke:encoded>'; }); };

        function H(O) { return O.replace(B, function(P, Q) { return decodeURIComponent(Q); }); };

        function I(O) { return O.replace(C, '$1cke:$2'); };

        function J(O) { return O.replace(D, '$1$2'); };

        function K(O) { return O.replace(E, '<cke:$1$2></cke:$1>'); };

        function L(O) { return O.replace(/<!--(?!{cke_protected})[\s\S]+?-->/g, function(P) { return '<!--' + m + '{C}' + encodeURIComponent(P).replace(/--/g, '%2D%2D') + '-->'; }); };

        function M(O) { return O.replace(/<!--\{cke_protected\}\{C\}([\s\S]+?)-->/g, function(P, Q) { return decodeURIComponent(Q); }); };

        function N(O, P) {
            var Q = [], R = /<\!--\{cke_temp(comment)?\}(\d*?)-->/g, S = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi].concat(P);
            O = O.replace(/<!--[\s\S]*?-->/g, function(U) { return '<!--{cke_tempcomment}' + (Q.push(U) - 1) + '-->'; });
            for (var T = 0; T < S.length; T++)
                O = O.replace(S[T], function(U) {
                    U = U.replace(R, function(V, W, X) { return Q[X]; });
    ...
    (function() {
        ...
        function m(r, s) { r.getCommand(this.name).setState(s); };
        ...
        function n(r) {
            ...
            if (t)
                if (C.name == 'outdent')return m.call(C, v, 2);
                else {
    ...
    j.add('link', {
        init: function(l) {
            ...
            if (l.contextMenu)
                l.contextMenu.addListener(function(m, n) {
                    if (!m)return null;
    ...
    (function() {
        ...
        function n(A, B) { A.getCommand(this.name).setState(B); };
        ...
        function r(A, B, C) {
            ...
            function P(Q) { if ((N = M[Q ? 'getFirst' : 'getLast']()) && !(N.is && N.isBlockBoundary()) && (O = B.root[Q ? 'getPrevious' : 'getNext'](d.walker.whitespaces(true))) && !(O.is && O.isBlockBoundary({ br: 1 })))A.document.createElement('br')[Q ? 'insertBefore' : 'insertAfter'](N); };
    ...
    (function() {
        ...
        j.add('maximize', {
            init: function(q) {
                ...
                q.addCommand('maximize', {
                    ...
                    exec: function() {
                        ...
                        if (this.state == 2) {
                            ...
                            else s.getBody().setStyles({ overflow: 'hidden', width: '0px', height: '0px' });
                            c ? setTimeout(function() { t.$.scrollTo(0, 0); }, 0) : t.$.scrollTo(0, 0);
                            ...
                            c ? setTimeout(function() { t.$.scrollTo(w.x, w.y); }, 0) : t.$.scrollTo(w.x, w.y);
                ...
                q.on('mode', function() { q.getCommand('maximize').setState(y); }, null, null, 100);
            }
        });
    })();
    j.add('newpage', {
        init: function(l) {
            l.addCommand('newpage', {
                ...
                exec: function(m) {
                    var n = this;
                    m.setData(m.config.newpage_html, function() { setTimeout(function() { m.fire('afterCommandExec', { name: n.name, command: n }); }, 200); });
                    m.focus();
                },
                async: true
            });
    ...
    (function() {
        j.add('pastefromword', {
            init: function(l) {
                var m = 0, n = function() { setTimeout(function() { m = 0; }, 0); };
                l.addCommand('pastefromword', {
                    canUndo: false,
                    exec: function() {
                        m = 1;
                        if (l.execCommand('paste') === false)
                            l.on('dialogHide', function(o) {
                                o.removeListener();
                                n();
                            });
                    }
    ...
    (function() {
        ...
        j.add('pastetext', {
            init: function(o) {
                ...
                if (o.config.forcePasteAsPlainText)
                    o.on('beforeCommandExec', function(r) {
        ...
        function n(o, p, q, r) { while (q--)j.enterkey[p == 2 ? 'enterBr' : 'enterBlock'](o, p, null, r); };
            ...
            removeformat: {
                exec: function(l) {
                    ...
                    for (var p = 0, q; q = o[p]; p++) {
                        ...
                        q.enlarge(1);
                        var r = q.createBookmark(), s = r.startNode, t = r.endNode,
                            u = function(x) {
                        ...
                        while (v) {
                            ...
                            if (!(v.getName() == 'img' && v.getAttribute('_cke_realelement')))
                                if (m.test(v.getName()))v.remove(true);
    ...
    j.add('resize', {
        init: function(l) {
            ...
            if (m.resize_enabled) {
                ...
                l.on('themeSpace', function(t) { if (t.data.space == 'bottom')t.data.html += '<div class="cke_resizer" title="' + e.htmlEncode(l.lang.resize) + '"' + ' onmousedown="CKEDITOR.tools.callFunction(' + s + ', event)"' + '></div>'; }, l, null, 100);
            }
        }
    });
    ...
    (function() {
        ...
        var p = function() {
            ...
            t.on('destroy', function() { q.getScayt(t).destroy(); });
            t.on('afterSetData', function() { if (q.isScaytEnabled(t))q.getScayt(t).refresh(); });
        ...
        j.scayt = {
            engineLoaded: false, instances: {}, getScayt: function(t) { return this.instances[t.name]; }, isScaytReady: function(t) { return this.engineLoaded === true && 'undefined' !== typeof window.scayt && this.getScayt(t); },
        ...
        var q = j.scayt,
            ...
            s = {
                preserveState: true, editorFocus: false,
                exec: function(t) {
                    if (q.isScaytReady(t)) {
        ...
        j.add('scayt', {
            requires: ['menubutton'],
            beforeInit: function(t) { t.config.menu_groups = 'scayt_suggest,scayt_moresuggest,scayt_control,' + t.config.menu_groups; },
            init: function(t) {
                ...
                if (y[0] == 1)
                    D.scaytOptions = {
                        label: t.lang.scayt.options, group: C,
                        onClick: function() {
                            m = 'options';
                            t.openDialog(l);
                        }
                ...
                if (y[1] == 1)
                    D.scaytLangs = {
                        label: t.lang.scayt.langs, group: C,
                        onClick: function() {
                            m = 'langs';
                            t.openDialog(l);
                        }
                ...
                if (y[2] == 1)
                    D.scaytDict = {
                        label: t.lang.scayt.dictionariesTab, group: C,
                        onClick: function() {
                            m = 'dictionaries';
                            t.openDialog(l);
                        }
                ...
                D.scaytAbout = {
                    label: t.lang.scayt.about, group: C,
                    onClick: function() {
                        m = 'about';
                        t.openDialog(l);
                    }
                ...
                t.addMenuItems(D);
                t.ui.add('Scayt', 5, {
                    label: t.lang.scayt.title, title: t.lang.scayt.title, className: 'cke_button_scayt', onRender: function() { w.on('state', function() { this.setState(w.state); }, this); },
                    onMenu: function() {
                ...
                if (t.contextMenu && t.addMenuItems)
                    t.contextMenu.addListener(function(F) {
                        ...
                        for (var P = 0, Q = K.length; P < Q; P += 1) {
                            var R = 'scayt_suggestion_' + K[P].replace(' ', '_'), S = (function(W, X) { return{ exec: function() { G.replace(W, X); } }; })(F.$, K[P]);
                            if (P < N) {
                        ...
                        if (M) {
                            t.addMenuItem('scayt_moresuggest', { label: t.lang.scayt.moreSuggestions, group: 'scayt_moresuggest', order: 10, getItems: function() { return u; } });
                            v.scayt_moresuggest = 2;
                        }
                        if (o('all', O) || o('ignore', O)) {
                            var T = { exec: function() { G.ignore(F.$); } };
                            r(t, 'ignore', t.lang.scayt.ignore, 'scayt_ignore', T, 'scayt_control', 1);
                            v.scayt_ignore = 2;
                        }
                        if (o('all', O) || o('ignoreall', O)) {
                            var U = { exec: function() { G.ignoreAll(F.$); } };
                            r(t, 'ignore_all', t.lang.scayt.ignoreAll, 'scayt_ignore_all', U, 'scayt_control', 2);
                            v.scayt_ignore_all = 2;
                        }
                        if (o('all', O) || o('add', O)) {
                            var V = { exec: function() { window.scayt.addWordToUserDictionary(F.$); } };
    ...
    (function() {
        ...
        j.add('showblocks', {
            ...
            init: function(p) {
                ...
                p.on('mode', function() { if (q.state != 0)q.refresh(p); });
                p.on('contentDom', function() { if (q.state != 0)q.refresh(p); });
            }
        });
    })();
    ...
    (function() {
        ...
        j.add('showborders', {
            ...
            init: function(p) {
                ...
                p.addCss(m);
                p.on('mode', function() { if (q.state != 0)q.refresh(p); }, null, null, 100);
                p.on('contentDom', function() { if (q.state != 0)q.refresh(p); });
            },
            afterInit: function(p) {
    ...
    j.add('sourcearea', {
        ...
        init: function(l) {
                ...
                l.addMode('source', {
                    load: function(q, r) {
                        ...
                        if (c) {
                            ...
                            n.on('resize', p);
                            setTimeout(p, 0);
                        } else o.on('mousedown', function(u) { u.data.stopPropagation(); });
                        q.setHtml('');
                        q.append(o);
                        o.setStyles(s);
                        l.fire('ariaWidget', o);
                        o.on('blur', function() { l.focusManager.blur(); });
                        o.on('focus', function() { l.focusManager.focus(); });
                        l.mayBeDirty = true;
                        this.loadData(r);
            ...
            l.on('mode', function() { l.getCommand('source').setState(l.mode == 'source' ? 1 : 2); });
        }
    });
    j.sourcearea = {
        commands: {
        ...
        j.add('stylescombo', {
            ...
            init: function(o) {
                ...
                o.ui.addRichCombo('Styles', {
                    ...
                    panel: { css: o.skin.editor.css.concat(p.contentsCss), multiSelect: true, attributes: { 'aria-label': q.panelTitle } },
                    init: function() {
                        var w = this;
    ...
    j.add('table', {
        init: function(l) {
            ...
            if (l.contextMenu)
                l.contextMenu.addListener(function(o, p) {
                    if (!o)return null;
    ...
    (function() {
        ...
        function u(E) {
            if (E instanceof d.selection) {
                ...
                if (E.getParent().getChildCount() == 1)E.getParent().remove();
                else E.remove();
        };
        ...
        j.tabletools = {
            init: function(E) {
                ...
                E.addCommand('cellMerge', { exec: function(G) { w(A(G.getSelection()), true); } });
                E.addCommand('cellMergeRight', { exec: function(G) { w(A(G.getSelection(), 'right'), true); } });
                E.addCommand('cellMergeDown', { exec: function(G) { w(A(G.getSelection(), 'down'), true); } });
                E.addCommand('cellVerticalSplit', { exec: function(G) { w(B(G.getSelection())); } });
                E.addCommand('cellHorizontalSplit', { exec: function(G) { w(C(G.getSelection())); } });
                ...
                if (E.addMenuItems)
                    E.addMenuItems({
                        tablecell: {
                            label: F.cell.menu, group: 'tablecell', order: 1,
                            getItems: function() {
                        ...
                        tablecell_insertBefore: { label: F.cell.insertBefore, group: 'tablecell', command: 'cellInsertBefore', order: 5 },
                        tablecell_insertAfter: { label: F.cell.insertAfter, group: 'tablecell', command: 'cellInsertAfter', order: 10 },
                        tablecell_delete: { label: F.cell.deleteCell, group: 'tablecell', command: 'cellDelete', order: 15 },
                        tablecell_merge: { label: F.cell.merge, group: 'tablecell', command: 'cellMerge', order: 16 },
                        tablecell_merge_right: { label: F.cell.mergeRight, group: 'tablecell', command: 'cellMergeRight', order: 17 },
                        tablecell_merge_down: { label: F.cell.mergeDown, group: 'tablecell', command: 'cellMergeDown', order: 18 },
                        tablecell_split_horizontal: { label: F.cell.splitHorizontal, group: 'tablecell', command: 'cellHorizontalSplit', order: 19 },
                        tablecell_split_vertical: { label: F.cell.splitVertical, group: 'tablecell', command: 'cellVerticalSplit', order: 20 },
                        tablecell_properties: { label: F.cell.title, group: 'tablecellproperties', command: 'cellProperties', order: 21 },
                        tablerow: {
                            label: F.row.menu,
                            group: 'tablerow',
                            order: 1,
                        ...
                        tablerow_insertBefore: { label: F.row.insertBefore, group: 'tablerow', command: 'rowInsertBefore', order: 5 },
                        tablerow_insertAfter: { label: F.row.insertAfter, group: 'tablerow', command: 'rowInsertAfter', order: 10 },
                        tablerow_delete: { label: F.row.deleteRow, group: 'tablerow', command: 'rowDelete', order: 15 },
                        tablecolumn: { label: F.column.menu, group: 'tablecolumn', order: 1, getItems: function() { return{ tablecolumn_insertBefore: 2, tablecolumn_insertAfter: 2, tablecolumn_delete: 2 }; } },
                        tablecolumn_insertBefore: { label: F.column.insertBefore, group: 'tablecolumn', command: 'columnInsertBefore', order: 5 },
                        tablecolumn_insertAfter: { label: F.column.insertAfter, group: 'tablecolumn', command: 'columnInsertAfter', order: 10 },
                        tablecolumn_delete: { label: F.column.deleteColumn, group: 'tablecolumn', command: 'columnDelete', order: 15 }
                    });
                if (E.contextMenu)
                    E.contextMenu.addListener(function(G, H) {
                        if (!G)return null;
                        while (G) {
    ...
    (function() {
        var l = { editorFocus: false, modes: { wysiwyg: 1, source: 1 } }, m = { exec: function(o) { o.container.focusNext(true, o.tabIndex); } }, n = { exec: function(o) { o.container.focusPrevious(true, o.tabIndex); } };
        j.add('tab', {
            requires: ['keystrokes'],
            init: function(o) {
    ...
    (function() {
        ...
        var l = {}, m = {};
        a.addTemplates = function(n, o) { l[n] = o; };
        a.getTemplates = function(n) { return l[n]; };
    ...
    (function() {
        ...
        l.prototype.focus = function() {
            for (var n = 0, o; o = this.toolbars[n++];)
                for (var p = 0, q; q = o.items[p++];) {
                    if (q.focus) {
                        q.focus();
                        return;
                    }
            ...
            toolbarFocus: {
                ...
                exec: function(n) {
                    if (n.toolbox) {
                        ...
                        if (c)setTimeout(function() { n.toolbox.focus(); }, 100);
                ...
                n.on('themeSpace', function(p) {
                    if (p.data.space == n.config.toolbarLocation) {
                        ...
                        for (var w = 0; w < v.length; w++) {
                            ...
                            for (var B = 0; B < x.length; B++) {
                                ...
                                if (C) {
                                    ...
                                    E.toolbar = z;
                                    E.onkey = o;
                                    E.onfocus = function() { if (!n.toolbox.focusCommandExecuted)n.focus(); };
                                }
                            }
                            if (t) {
                                r.push('</span>');
                        ...
                        if (n.config.toolbarCanCollapse) {
                            var F = e.addFunction(function() { n.execCommand('toolbarCollapse'); }), G = 'cke_' + e.getNextNumber();
    ...
    (function() {
        j.add('undo', {
            ...
            init: function(r) {
                ...
                function v(w) { if (s.enabled && w.data.command.canUndo !== false)s.save(); };

                r.on('beforeCommandExec', v);
                r.on('afterCommandExec', v);
                r.on('saveSnapshot', function() { s.save(); });
                r.on('contentDom', function() { r.document.on('keydown', function(w) { if (!w.data.$.ctrlKey && !w.data.$.metaKey)s.type(w); }); });
                r.on('beforeModeUnload', function() { r.mode == 'wysiwyg' && s.save(true); });
                r.on('mode', function() {
    ...
    (function() {
        ...
        function o(v) {
            if (this.mode == 'wysiwyg') {
                ...
                for (var G = A.length - 1; G >= 0; G--) {
                    ...
                    var H, I;
                    if (y)
                        while ((H = C.getCommonAncestor(false, true)) && (I = f[H.getName()]) && !(I && I[x])) {
                            if (H.getName() in f.span)C.splitElement(H);
        ...
        function p(v) { if (!v.checkDirty())setTimeout(function() { v.resetDirty(); }); };

        var q = d.walker.whitespaces(true), r = d.walker.bookmark(false, true);

        function s(v) { return q(v) && r(v); };

        function t(v) { return v.type == 3 && e.trim(v.getText()).match(/^(?:&nbsp;|\xa0)$/); };
                ...
                v.on('editingBlockReady', function() {
                    var A,
                        ...
                        J = function(K) {
                            ...
                            if (!(c || b.opera))
                                L.on('mousedown', function(U) {
                                    var V = U.data.getTarget();
                                    if (V.is('img', 'hr', 'input', 'textarea', 'select'))v.getSelection().selectElement(V);
                                });
                            if (b.webkit) {
                                L.on('click', function(U) { if (U.data.getTarget().is('input', 'select'))U.data.preventDefault(); });
                                L.on('mouseup', function(U) { if (U.data.getTarget().is('input', 'textarea'))U.data.preventDefault(); });
                            }
                            if (c && L.$.compatMode == 'CSS1Compat') {
                                var O = L.getDocumentElement();
                                O.on('mousedown', function(U) { if (U.data.getTarget().equals(O))z.focus(); });
                            }
                            var P = c || b.webkit ? K : L;
                            P.on('blur', function() { v.focusManager.blur(); });
                            P.on('focus', function() {
                                if (b.gecko) {
                                    var U = M;
                                    ...
                                    if (!U.nextSibling && 'BR' == U.tagName && U.hasAttribute('_moz_editor_bogus_node')) {
                                        ...
                                        if (v.config.enterMode == 2)L.createElement('br', { attributes: { _moz_dirty: '' } }).replace(W);
                                        else W.remove();
                                    }
                                }
                            ...
                            if (c) {
                                ...
                                if (L.$.compatMode == 'CSS1Compat') {
                                    var R = { 33: 1, 34: 1 };
                                    L.on('keydown', function(U) { if (U.data.getKeystroke() in R)setTimeout(function() { v.getSelection().scrollIntoView(); }, 0); });
                                }
                            }
                            ...
                            setTimeout(function() {
                                ...
                                setTimeout(function() { v.fire('dataReady'); }, 0);
                                if (c)
                                    setTimeout(function() {
                                        if (v.document) {
                    ...
                    v.addMode('wysiwyg', {
                        ...
                        loadData: function(K) {
                            ...
                            if (M)
                                K = K.replace(/<!DOCTYPE[^>]*>/i, function(Q) {
                                    v.docType = N = Q;
                                    return '';
                                });
                        ...
                        getSnapshotData: function() { return B.getFrameDocument().getBody().getHtml(); },
                        loadSnapshotData: function(K) { B.getFrameDocument().getBody().setHtml(K); },
                        unload: function(K) {
        ...
        (function() {
            ...
            if (!v)window.addEventListener('load', arguments.callee, false);
                ...
                v.setAttribute('onpageshow', v.getAttribute('onpageshow') + ';event.persisted && CKEDITOR.tools.callFunction(' + e.addFunction(function() {
    ...
    (function() {
        function l(K) { return!!this._.tabs[K][0].$.offsetHeight; };
        ...
        a.dialog = function(K, L) {
            ...
            this.parts = O.parts;
            e.setTimeout(function() { K.fire('ariaWidget', this.parts.contents); }, 0, this);
            ...
            if (M.onOk)this.on('ok', function(aa) { if (M.onOk.call(this, aa) === false)aa.data.hide = false; });
            if (M.onCancel)
            ...
            this.parts.close.on('click', function(aa) { if (this.fire('cancel', { hide: true }).hide !== false)this.hide(); }, this);
            ...
            function V(aa) { T && aa.data.preventDefault(); };
            ...
            this.on('show', function() {
                ...
                if (K.config.dialog_startupFocusTab && P._.tabIdList.length > 1) {
                    ...
                    if (ae._.editor.mode == 'wysiwyg' && c) {
                        ...
                        if (ac)
                            if (ac.parentElement && ac.parentElement().ownerDocument == K.document.$ || ac.item && ac.item(0).ownerDocument == K.document.$) {
        ...
        function o(K, L, M) {
            ...
            this.focusIndex = M;
            this.tabIndex = 0;
            this.isFocusable = function() { return!L.getAttribute('disabled') && L.isVisible(); };
            this.focus = function() {
                K._.currentFocusIndex = this.focusIndex;
                this.element.focus();
            };
            L.on('keydown', function(N) { if (N.data.getKeystroke() in { 32: 1, 13: 1 })this.fire('click'); });
            L.on('focus', function() { this.fire('mouseover'); });
            L.on('blur', function() { this.fire('mouseout'); });
        };
        ...
        a.dialog.prototype = {
            ...
            show: function() {
                ...
                if (b.gecko && b.version < 10900) {
                    ...
                    setTimeout(function() { O.setStyle('position', 'fixed'); }, 0);
                }
                ...
                E(this, this, '\x1b', null, function() { this.getButton('cancel') && this.getButton('cancel').click(); });
                ...
                e.setTimeout(function() {
                    ...
                    this.foreach(function(T) { T.setInitValue && T.setInitValue(); });
                }, 100, this);
            },
            foreach: function(K) {
                var N = this;
            ...
            reset: (function() {
                var K = function(L) { if (L.reset)L.reset(); };
                return function() {
                    this.foreach(K);
                    return this;
                };
            ...
            setupContent: function() {
                var K = arguments;
                this.foreach(function(L) { if (L.setup)L.setup.apply(L, K); });
            },
            commitContent: function() {
                var K = arguments;
                this.foreach(function(L) { if (L.commit)L.commit.apply(L, K); });
            },
            hide: function() {
                this.fire('hide', {});
                ...
                this.foreach(function(P) { P.resetInitValue && P.resetInitValue(); });
            },
            addPage: function(K) {
                var W = this;
            ...
            getValueOf: function(K, L) { return this.getContentElement(K, L).getValue(); },
            setValueOf: function(K, L, M) { return this.getContentElement(K, L).setValue(M); },
            ...
            enableButton: function(K) { return this._.buttons[K].enable(); },
        ...
        e.extend(a.dialog, {
            add: function(K, L) { if (!this._.dialogDefinitions[K] || typeof L == 'function')this._.dialogDefinitions[K] = L; }, exists: function(K) { return!!this._.dialogDefinitions[K]; }, getCurrent: function() { return a.dialog._.currentTop; },
            okButton: (function() {
                var K = function(L, M) {
                    M = M || {};
                    return e.extend({
                        id: 'ok', type: 'button', label: L.lang.common.ok, 'class': 'cke_dialog_ui_button_ok',
                        onClick: function(N) {
                            var O = N.data.dialog;
                ...
                K.type = 'button';
                K.override = function(L) { return e.extend(function(M) { return K(M, L); }, { type: 'button' }, true); };
                return K;
            })(),
            cancelButton: (function() {
                var K = function(L, M) {
                    M = M || {};
                    return e.extend({
                        id: 'cancel', type: 'button', label: L.lang.common.cancel, 'class': 'cke_dialog_ui_button_cancel',
                        onClick: function(N) {
                            var O = N.data.dialog;
            ...
            addUIElement: function(K, L) { this._.uiElementBuilders[K] = L; }
        });
        ...
        var p = { resizable: 0, minWidth: 600, minHeight: 400, buttons: [a.dialog.okButton, a.dialog.cancelButton] },
            q = function(K, L, M) {
        ...
        t.prototype = {
            ...
            getButton: function(K) { return q(this.buttons, K); },
            addContents: function(K, L) { return r(this.contents, K, L); },
            addButton: function(K, L) { return r(this.buttons, K, L); },
            removeContents: function(K) { s(this.contents, K); },
            removeButton: function(K) { s(this.buttons, K); }
        };
        ...
        u.prototype = { get: function(K) { return q(this.elements, K, 'children'); }, add: function(K, L) { return r(this.elements, K, L, 'children'); }, remove: function(K) { s(this.elements, K, 'children'); } };
        ...
        function w(K) {
            ...
            function Q(ab, ac) { ab.y += ac; };

            function R(ab, ac) { ab.x2 += ac; };

            function S(ab, ac) { ab.y2 += ac; };

            function T(ab, ac) { ab.x += ac; };
        ...
        var x,
            ...
            G = function(K, L) { if (K._.accessKeyMap[L])K.selectPage(K._.accessKeyMap[L]); },
            H = function(K, L) {},
            I = { 27: 1, 13: 1 },
            J = function(K) { if (K.data.getKeystroke() in I)K.data.stopPropagation(); };
        (function() {
            k.dialog = {
                uiElement: function(K, L, M, N, O, P, Q) {
                    ...
                    if (typeof L.isChanged == 'boolean')this.isChanged = function() { return L.isChanged; };
                    ...
                    var ad = this;
                    K.on('load', function() {
                        if (ad.getInputElement())
                            ad.getInputElement().on('focus', function() {
                    ...
                    if (this.keyboardFocusable) {
                        ...
                        this.on('focus', function() { K._.currentFocusIndex = ad.focusIndex; });
                    }
                    e.extend(this, L);
                },
                ...
                vbox: function(K, L, M, N, O) {
                    ...
                    this._ || (this._ = {});
                    var P = this._.children = L, Q = O && O.width || null, R = O && O.heights || null,
                        S = function() {
        ...
        k.dialog.uiElement.prototype = {
            ...
            registerEvents: function(K) {
                var L = /^on([A-Z]\w+)/, M, N = function(P, Q, R, S) { Q.on('load', function() { P.getInputElement().on(R, S, P); }); };
                for (var O in K) {
            ...
            eventProcessors: { onLoad: function(K, L) { K.on('load', L, this); }, onShow: function(K, L) { K.on('show', L, this); }, onHide: function(K, L) { K.on('hide', L, this); } },
            accessKeyDown: function(K, L) { this.focus(); },
        ...
        a.dialogCommand = function(K) { this.dialogName = K; };
        a.dialogCommand.prototype = { exec: function(K) { K.openDialog(this.dialogName); }, canUndo: false, editorFocus: c };
        (function() {
            var K = /^([a]|[^a])+$/, L = /^\d*$/, M = /^\d*(?:\.\d+)?$/;
            a.VALIDATE_OR = 1;
            a.VALIDATE_AND = 2;
            a.dialog.validate = {
                ...
                notEmpty: function(N) { return this.regex(K, N); },
                integer: function(N) { return this.regex(L, N); },
                number: function(N) { return this.regex(M, N); },
                equals: function(N, O) { return this.functions(function(P) { return P == N; }, O); },
                notEqual: function(N, O) { return this.functions(function(P) { return P != N; }, O); }
            };
        })();
    })();
    e.extend(a.editor.prototype, {
    ...
    (function() {
        ...
        a.style.prototype = {
            apply: function(L) { K.call(this, L, false); },
            remove: function(L) { K.call(this, L, true); },
            applyToRange: function(L) {
                var M = this;
                return(M.applyToRange = M.type == 2 ? o : M.type == 1 ? q : null).call(M, L);
            },
            removeFromRange: function(L) { return(this.removeFromRange = this.type == 2 ? p : null).call(this, L); },
            applyToObject: function(L) { E(L, this); },
        ...
        function t(L) {
            var M = /(\S\s*)\n(?:\s|(<span[^>]+_fck_bookmark.*?\/span>))*\n(?!$)/gi, N = L.getName(), O = u(L.getOuterHtml(), M, function(Q, R, S) { return R + '</pre>' + S + '<pre>'; }), P = [];
            O.replace(/<pre>([\s\S]*?)<\/pre>/gi, function(Q, R) { P.push(R); });
            return P;
        };
        ...
        function v(L, M) {
            ...
            for (var O = 0; O < L.length; O++) {
                ...
                P = P.replace(/\n/g, '<br>');
                P = P.replace(/[ \t]{2,}/g, function(R) { return e.repeat('&nbsp;', R.length - 1) + ' '; });
                var Q = M.clone();
                Q.setHtml(P);
                N.append(Q);
            }
        ...
        function G(L, M) { for (var N in L)L[N] = L[N].replace(F, function(O, P) { return M[P]; }); };
    ...
    a.styleCommand = function(l) { this.style = l; };
    a.styleCommand.prototype.exec = function(l) {
        var n = this;
        l.focus();
        var m = l.document;
        if (m)
            if (n.state == 2)n.style.apply(m);
    ...
    (function() {
        ...
        k.panelButton = e.createClass({
            ...
            statics: { handler: { create: function(m) { return new k.panelButton(m); } } },
            proto: {
        ...
        k.floatPanel = e.createClass({
            ...
            proto: {
                ...
                showBlock: function(o, p, q, r, s) {
                    ...
                    t.onEscape = e.bind(function(D) { if (this.onEscape && this.onEscape(D) === false)return false; }, this);
                    e.setTimeout(function() {
                ...
                showAsChild: function(o, p, q, r, s, t) {
                    ...
                    this.hideChild();
                    o.onHide = e.bind(function() { e.setTimeout(function() { if (!this._.focused)this.hide(); }, 0, this); }, this);
                    this._.activeChild = o;
                    this._.focused = false;
                    o.showBlock(p, q, r, s, t);
                    if (b.ie7Compat || b.ie8 && b.ie6Compat)setTimeout(function() { o.element.getChild(0).$.style.cssText += ''; }, 100);
                },
                hideChild: function() {
    ...
    j.add('menu', {
        beforeInit: function(l) {
            ...
            l.addMenuGroup = function(q, r) { n[q] = r || 100; };
            l.addMenuItem = function(q, r) { if (n[r.group])o[q] = new a.menuItem(this, q, r); };
            l.addMenuItems = function(q) { for (var r in q)this.addMenuItem(r, q[r]); };
            l.getMenuItem = function(q) { return o[q]; };
        },
        requires: ['floatpanel']
    });
    (function() {
            ...
            proto: {
                ...
                show: function(m, n, o, p) {
                    ...
                    if (!s) {
                        ...
                        s.onEscape = e.bind(function(C) { if (this.onEscape && this.onEscape(C) === false)return false; }, this);
                        s.onHide = e.bind(function() { this.onHide && this.onHide(); }, this);
                        ...
                        this._.itemOutFn = e.addFunction(function(C) { clearTimeout(this._.showSubTimeout); }, this);
    ...
    (function() {
        var l = function(n, o) { return n._.modes && n._.modes[o || n.mode]; }, m;
        j.add('editingblock', {
            init: function(n) {
                ...
                n.on('loadSnapshot', function(o) { if (n.mode)l(n).loadSnapshotData(o.data); });
            ...
            init: function(s) {
                s.on('contentDom', function() {
                    ...
                    if (c) {
                        ...
                        u.on('beforedeactivate', function() { w = false; });
                        u.on('mousedown', x);
                        u.on('mouseup', function() {
                            w = true;
                            setTimeout(function() { y(true); }, 0);
                        });
                        u.on('keydown', x);
                        u.on('keyup', function() {
                            w = true;
                        ...
                        function y(z) {
                            if (w) {
                                ...
                                if (z && B && B.type == 'None')
                                    if (!A.$.queryCommandEnabled('InsertImage')) {
                ...
                var s = function(t, u) {
                    ...
                    for (var y = 0; y < w.length; y++) {
                        ...
                        if (z.nodeType == 1) {
                            ...
                            x.collapse();
                            if (A > 0)break;
                            else if (!A || B == 1 && A == -1)return{ container: v, offset: y };
                    ...
                    if (C === 0)return{ container: v, offset: y };
                    else return{ container: w[y], offset: -C };
                };
                return function() {
                    var E = this;
                    var t = E._.cache;
    ...
    j.add('richcombo', { requires: ['floatpanel', 'listblock', 'button'], beforeInit: function(l) { l.ui.addHandler(3, k.richCombo.handler); } });
    a.UI_RICHCOMBO = 3;
    k.richCombo = e.createClass({
        ...
        proto: {
            ...
            render: function(l, m) {
                ...
                l.on('mode', function() { this.setState(this.modes[l.mode] ? 2 : 0); }, this);
    ...
    k.prototype.addRichCombo = function(l, m) { this.add(l, 3, m); };
    j.add('htmlwriter');
    ...
    j.add('menubutton', { requires: ['button', 'contextmenu'], beforeInit: function(l) { l.ui.addHandler(5, k.menuButton.handler); } });
    a.UI_MENUBUTTON = 5;
    (function() {
        var l = function(m) {
            var n = this._;
            ...
            if (!o) {
                ...
                o.onHide = e.bind(function() { this.setState(n.previousState); }, this);
        ...
        k.menuButton = e.createClass({
            ...
            statics: { handler: { create: function(m) { return new k.menuButton(m); } } }
        });
    })();
    j.add('dialogui');
    (function() {
        var l = function(t) {
            ...
            m = { build: function(t, u, v) { return new k.dialog.textInput(t, u, v); } },
            n = { build: function(t, u, v) { return new k.dialog[u.type](t, u, v); } },
            o = {
            ...
            p = { isChanged: function() { return this.getValue() != this.getInitValue(); }, reset: function() { this.setValue(this.getInitValue()); }, setInitValue: function() { this._.initValue = this.getValue(); }, resetInitValue: function() { this._.initValue = this._['default']; }, getInitValue: function() { return this._.initValue; } },
            q = e.extend({}, k.dialog.uiElement.prototype.eventProcessors, {
                onChange: function(t, u) {
                    if (!this._.domOnChangeRegistered) {
                        t.on('load', function() { this.getInputElement().on('change', function() { this.fire('change', { value: this.getValue() }); }, this); }, this);
        ...
        e.extend(k.dialog, {
                ...
                var y = this._.children = [],
                    z = function() {
                        ...
                        if (u.labelLayout != 'horizontal')A.push('<label class="cke_dialog_ui_labeled_label" ', ' id="' + x.labelId + '"', ' for="' + x.inputId + '"', ' style="' + u.labelStyle + '">', u.label, '</label>', '<div class="cke_dialog_ui_labeled_content" role="presentation">', w.call(this, t, u), '</div>');
                            ...
                            var B = { type: 'hbox', widths: u.widths, padding: 0, children: [{ type: 'html', html: '<label class="cke_dialog_ui_labeled_label" id="' + x.labelId + '"' + ' for="' + x.inputId + '"' + ' style="' + u.labelStyle + '">' + e.htmlEncode(u.label) + '</span>' }, { type: 'html', html: '<span class="cke_dialog_ui_labeled_content">' + w.call(this, t, u) + '</span>' }] };
            ...
            textInput: function(t, u, v) {
                ...
                var z = this, A = false;
                t.on('load', function() {
                    z.getInputElement().on('keydown', function(C) { if (C.data.getKeystroke() == 13)A = true; });
                    z.getInputElement().on('keyup', function(C) {
                        if (C.data.getKeystroke() == 13 && A) {
                            t.getButton('ok') && setTimeout(function() { t.getButton('ok').click(); }, 0);
                            A = false;
                        }
                    }, null, null, 1000);
                });
            ...
            fileButton: function(t, u, v) {
                ...
                t.on('load', function() { t.getContentElement(u['for'][0], u['for'][1])._.buttons.push(x); });
        ...
        k.dialog.button.prototype = e.extend(new k.dialog.uiElement(), {
            ...
            eventProcessors: e.extend({}, k.dialog.uiElement.prototype.eventProcessors, { onClick: function(t, u) { this.on('click', u); } }, true),
        ...
        k.dialog.file.prototype = e.extend(new k.dialog.labeledElement(), p, {
            ...
            getAction: function(t) { return this.getInputElement().getParent().$.action; },
            reset: function() {
    ...
    j.add('panel', { beforeInit: function(l) { l.ui.addHandler(2, k.panel.handler); } });
    a.UI_PANEL = 2;
    ...
    k.panel.handler = { create: function(l) { return new k.panel(l); } };
    k.panel.prototype = {
        renderHtml: function(l) {
            var m = [];
            this.render(l, m);
    ...
    j.add('listblock', {
        requires: ['panel'],
        onLoad: function() {
            k.panel.prototype.addListBlock = function(l, m) { return this.addBlock(l, new k.listBlock(this.getHolderElement(), m)); };
            k.listBlock = e.createClass({
                ...
                _: {
                    ...
                    getClick: function() {
                        if (!this._.click)
                            this._.click = e.addFunction(function(l) {
                                var n = this;
                                var m = true;
                ...
                proto: {
                    ...
                    unmark: function(l) { this.element.getDocument().getById(this._.items[l]).removeClass('cke_selected'); },
                    unmarkAll: function() {
    ...
    a.themes.add('default', (function() {
        function l(m, n) {
            ...
            if (p) {
                ...
                m.on('destroy', function() { r.remove(); });
            }
            return o;
        };
    ...
    a.editor.prototype.getResizable = function() { return this.container.getChild(1); };
})();