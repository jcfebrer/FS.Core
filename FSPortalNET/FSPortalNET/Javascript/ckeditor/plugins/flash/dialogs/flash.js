    ...
    CKEDITOR.dialog.add('flash', function(i) {
        ...
        return{
            ...
            onOk: function() {
                ...
                var v = i.createFakeElement(n || o, 'cke_flash', 'flash', true);
                v.setStyles(u);
                if (w.fakeImage) {
                    v.replace(w.fakeImage);
                    i.getSelection().selectElement(v);
                } else i.insertElement(v);
            },
                            ...
                            children: [
                                {
                                    ...
                                    children: [
                                        {
                                            id: 'src', type: 'text', label: i.lang.common.url, required: true, validate: CKEDITOR.dialog.validate.notEmpty(i.lang.flash.validateSrc), setup: g, commit: h,
                                            onLoad: function() {
                                                ...
                                                this.on('change', function(p) { if (p.data && p.data.value)o(p.data.value); });
                                                this.getInputElement().on('change', function(p) { o(this.getValue()); }, this);
                                            }
                            ...
                            children: [
                                {
                                    ...
                                    validate: CKEDITOR.dialog.validate.integer(i.lang.flash.validateWidth),
                                    ...
                                    type: 'text', id: 'height', style: 'width:95px', label: i.lang.flash.height, validate: CKEDITOR.dialog.validate.integer(i.lang.flash.validateHeight),
                                    setup: function(n, o, p, q) {
                                        g.apply(this, arguments);
                                        if (q) {
