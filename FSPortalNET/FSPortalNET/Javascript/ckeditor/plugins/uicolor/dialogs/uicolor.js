...
CKEDITOR.dialog.add('uicolor', function(a) {
    ...
    d = {
        id: 'yuiColorPicker', type: 'html', html: "<div id='cke_uicolor_picker' style='width: 360px; height: 200px; position: relative;'></div>",
        onLoad: function(i) {
        ...
        contents: [
            {
                ...
                elements: [
                    d, {
                        ...
                        children: [
                            {
                                id: 'livePeview', type: 'checkbox', label: a.lang.uicolor.preview, 'default': 1, onLoad: function() { h = true; },
                                onChange: function() {
                                    if (h)return;
