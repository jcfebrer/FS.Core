...
var consultaAlbaranes = ('pagina.aspx?id=318');
var consultaFacturas = ('p_consulta_facturas.aspx');
var consultaPagos = ('p_vencimientos_iso.aspx');
...
var consultaFabricas = ('p_Fabricas.aspx');
var consultaTelefonos = ('p_telefonos.aspx');
var consultaVencimientosISO = ('p_vencimientos_iso.aspx');

var CerrarSesion = ('servicios/desconectar.aspx');
var ChPass = ('/4daction/wChPassTransportistas');
...
var dds = ('p_directorio_sector.aspx'); //",,"Directorio del sector",1
var str = ('p_servicios.aspx'); //",,"Servicios transportistas",1
var cdc = ('p_callejero_ciudades.aspx'); //",,"Callejero de ciudades",1
var edl = ('p_estado_carreteras.aspx'); //",,"Estado de las carreteras",1
var cdf = ('p_calendario_fiestas.aspx'); //",,"Calendario de fiestas",1
var pdt = ('p_revision_tiempo.aspx'); //",,"Previsi&oacute;n del tiempo",1
var dco = ('p_donde_comer.aspx'); //",,"Donde comer",1
var ddo = ('p_donde_dormir.aspx'); //",,"Donde dormir",1
var las = ('p_las_asociaciones.aspx'); //",,"Las asociaciones",1
var edi = ('p_enlaces_interes.aspx'); //",,"Enlaces de inter&eacute;s",1
var con = ('p_consultas.aspx'); //)",,"Consultas",1
var nds = ('p_noticias_sector.aspx'); //",,"Noticias del sector",1


addmenu(menu = [
    "INFORMACION DEL SECTOR",,, 162, 1, "", plain_style,,, effect,,,,,,,, "form1",,,,, "&nbsp;&nbsp;&nbsp;Marco jur&iacute;dico", "javascript:abrir(maj)",, "Marco jur&iacute;dico", 1, "&nbsp;&nbsp;&nbsp;Directorio del sector", "javascript:abrir(dds)",, "Directorio del sector", 1, "&nbsp;&nbsp;&nbsp;Servicios transportistas", "javascript:abrir(str)",, "Servicios transportistas", 1, "&nbsp;&nbsp;&nbsp;Callejero de ciudades", "javascript:abrir(cdc)",, "Callejero de ciudades", 1, "&nbsp;&nbsp;&nbsp;Estado de las carreteras", "javascript:abrir(edl)",, "Estado de las carreteras", 1
//,"&nbsp;&nbsp;&nbsp;Calendario de fiestas","javascript:abrir(cdf)",,"Calendario de fiestas",1
    , "&nbsp;&nbsp;&nbsp;Previsi&oacute;n del tiempo", "javascript:abrir(pdt)",, "Previsi&oacute;n del tiempo", 1, "&nbsp;&nbsp;&nbsp;Donde comer", "javascript:abrir(dco)",, "Donde comer", 1, "&nbsp;&nbsp;&nbsp;Donde dormir", "javascript:abrir(ddo)",, "Donde dormir", 1, "&nbsp;&nbsp;&nbsp;Las asociaciones", "javascript:abrir(las)",, "Las asociaciones", 1, "&nbsp;&nbsp;&nbsp;Enlaces de inter&eacute;s", "javascript:abrir(edi)",, "Enlaces de inter&eacute;s", 1,"&nbsp;&nbsp;&nbsp;Noticias del sector", "javascript:abrir(nds)",, "Noticias del sector", 1
]);
addmenu(menu = [
    "INTRANET",,, 162, 1, "", plain_style,,, effect,,,,,,,, "form1",,,,
//,"&nbsp;&nbsp;&nbsp;Cambiar contrase&ntilde;a","javascript:location.href=(ChPass)",,"Cambiar contrase&ntilde;a",1
