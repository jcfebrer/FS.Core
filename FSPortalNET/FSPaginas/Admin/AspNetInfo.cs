...
{
    public class AspNetInfo : BasePage
    {
        ...
        {
            contenido += Ui.HtmlTable(GetSystemInfo());
            contenido += Ui.HtmlTable(GetSystemProcessorInfo());
            contenido += Ui.HtmlTable(GetSystemMemoryInfo());
            contenido += Ui.HtmlTable(GetSystemStorageInfo());
            contenido += Ui.HtmlTable(GetRequestHeaderInfo());
            contenido += Ui.HtmlTable(GetServerVariables());
            contenido += Ui.HtmlTable(GetEnvironmentVariables());
            contenido += Ui.HtmlTable(GetSessionInfo());
            contenido += Ui.HtmlTable(GetSystemObjectInfo());
            contenido += Ui.HtmlTable(GetMailObjectInfo());
            contenido += Ui.HtmlTable(GetUploadObjectInfo());
            contenido += Ui.HtmlTable(GetGraphicsObjectInfo());
            contenido += Ui.HtmlTable(GetOtherObjectInfo());
        }
    }
}
