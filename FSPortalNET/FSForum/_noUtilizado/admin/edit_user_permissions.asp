...
If NOT rsCommon.EOF Then
	...
	'Read in the user usuario from the recordset
...
<title>Edit Member Permissions</title>
...
<div align="center"><span class="heading">Edit Member Permissions for <% = strMemberName %></span><br />
 ...
 <br />
 <span class="text">Use the form below to Edit the Member Permissions for <% = strMemberName %> on the forum <% = strForumName %></span></div>
<form method="post" name="frmNewForum" action="edit_user_permissions.aspx?FID=<% = portal.variablesForum.intForumID %>&amp;uID=<% = lngMemberID %>">
 <br />
 <table width="450" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#000000">
  <tr>
   <td width="450"> <table width="100%" border="0" align="center" class="normal" cellpadding="4" cellspacing="1">
     <tr bgcolor="#CCCEE6">
      <td colspan="2" class="tHeading"><b><% = strForumName %> Forum<br /> <% = strMemberName %> Permissions</b></td>
     </tr>
     <tr bgcolor="#F5F5FA"> 
 ...
 <div align="center"><br />
  ...
  <input type='submit' name="Submit" value="Update Member Permissions" />
