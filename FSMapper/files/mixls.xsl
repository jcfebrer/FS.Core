  ...
  <xsl:template match="/">
    <DatosServicios>
      <Servicios>
        ...
        <xsl:for-each select="CARGAS/CABECERA_AGRUPACION/CABECERA_ENTREGA/DIRECCION">
          <NombreLinea>
            <xsl:value-of select="." />
          </NombreLinea>
        </xsl:for-each>
        ...
        <xsl:for-each select="CARGAS/CABECERA_AGRUPACION/CABECERA_ENTREGA/PROVINCIA">
          <IdentificacionImo xml:space="preserve"> <xsl:value-of select="." /></IdentificacionImo>
        </xsl:for-each>
