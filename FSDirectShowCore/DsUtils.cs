    ...
    { 
        ...
        { 
            ...
            { 
                ...
                spec = ( ( ISpecifyPropertyPages )( comObj ) ); 
                if ( spec == null ) 
                { 
                    return false; 
                } 
                ...
                hr = OleCreatePropertyFrame( hwnd, 30, 30, null, 1, comObj, cauuid.cElems, cauuid.pElems, 0, 0, IntPtr.Zero ); 
                return true; 
            } 
            catch ( Exception ee ) 
            { 
        ...
        private static extern int OleCreatePropertyFrame( IntPtr hwndOwner, int x, int y, string lpszCaption, int cObjects, [ In(), MarshalAs( UnmanagedType.Interface ) ]object ppUnk, int cPages, IntPtr pPageClsID, int lcid, int dwReserved, IntPtr pvReserved );
    } 
    ...
    { 
        ...
        { 
            ...
            { 
                ...
                int iuInt = System.Convert.ToInt32( iuPtr ); 
        ...
        { 
            ...
            try 
            { 
                int hr = GetRunningObjectTable( 0, rot ); 
                if ( hr < 0 ) 
                { 
                    Marshal.ThrowExceptionForHR( hr ); 
                } 
        ...
        private static extern int GetRunningObjectTable( int r, System.Runtime.InteropServices.ComTypes.IRunningObjectTable pprot );
        
        [ DllImport( "ole32.dll", CharSet=CharSet.Unicode, ExactSpelling=true ) ]
        private static extern int CreateItemMoniker( string delim, string item, System.Runtime.InteropServices.ComTypes.IMoniker ppmk );
