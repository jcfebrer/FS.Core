...
namespace FSUblCore
{
    public class CreateInvoice
    {
        public void Create(string xmlFilename, string moneda, string facturaId, 
            ...
            decimal totalImporteBruto, decimal totalFactura, FSUblCore.Cac.InvoiceLineType[] lineas)
        {
            FSUblCore.InvoiceType invoice = CreateInvoiceData(moneda, facturaId, fechaFactura, 
            ...
            setting.Indent = true;
            setting.IndentChars = FSLibraryCore.TextUtil.ControlChars.Tab.ToString();
            
            using (XmlWriter writer = XmlWriter.Create(xmlFilename, setting))
            {
                Type typeToSerialize = typeof(FSUblCore.InvoiceType);
        ...
        private static FSUblCore.InvoiceType CreateInvoiceData(string moneda, 
            ...
            decimal totalImporteBruto, decimal totalFactura, FSUblCore.Cac.InvoiceLineType[] lineas)
        {
            ...
            FSUblCore.UblBaseDocumentType.GlbCustomizationID =
                "urn:tradeshift.com:ubl-2.0-customizations:2010-06";
            FSUblCore.UblBaseDocumentType.GlbProfileID =
            ...
            FSUblCore.InvoiceType res = new FSUblCore.InvoiceType
            {
