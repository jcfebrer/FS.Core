    ...
    public class UPnP4
    {
        ...
        private static string getServicesFromDevice(string firewallIP)
        {
            ...
            try
            {
                ...
                IPEndPoint sender = new IPEndPoint(Net.GetInternetIPAddress(), 0);
        ...
        public static void openPortFromService(string services, string serviceType, string machineIP, string firewallIP, int gatewayPort, int portToForward)
        {
            ...
            string soapBody = "<s:Envelope " +
                ...
                portToForward.ToString() + "</NewExternalPort>" +
                "<NewProtocol>TCP</NewProtocol>" + "<NewInternalPort>" +
                portToForward.ToString() + "</NewInternalPort>" +
